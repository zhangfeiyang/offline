...
def get_parser():
    ...
    parser.add_argument("--mac", default="run_mu.mac", help="mac file")
...
GENERATOR_EXEC = {"IBD": "IBD.exe -n {EVENT} -seed {SEED}|",
                  ...
                  "Muon": "Muon.exe -n {EVENT} -seed {SEED} -s juno -v Rock -r Yes -mult 1 -music_dir %s|"%muon_data
                  }
...
if __name__ == "__main__":
    ...
    # To run the muon simulation, disable the Optical Model
    if args.detoption == "Acrylic":
        ...
        acrylic_conf.set_muon_output()
        acrylic_conf.set_muonIso_output()
        acrylic_conf.set_muonFastn_output()
        acrylic_conf.set_veto_pmt_mode("CalMode")
