...
void RecAnalysis()
{
  ...
  std::string topdir = "/junofs/production/validation/J16v2r1-Pre4/zhaobq/Positron/center";
...
void RecAnalysisSingleEnergy(const char* simFilePath,const char* recFilePath,const char* recwoFilePath,int evtNum,int jobNum,int& baseline, int energyIndex){
    ...
    h_E[energyIndex]= new TH1F(Form("Erec%d",energyIndex+1),Form("Erec_%d",energyIndex+1),300,energyIndex,energyIndex*2+2);
    h_PE[energyIndex]= new TH1F(Form("h_PE_%d",energyIndex+1),Form("total_PE",energyIndex+1),300,(energyIndex)*1300., (energyIndex*2+2)*1300.);
    h1_E[energyIndex]= new TH1F(Form("(Erec-Edep)/Edep_%d",energyIndex+1),Form("(Erec-Edep)/Edep_%d",energyIndex+1),EN_NUM,-0.3,0.3);
    h1_PE[energyIndex]= new TH1F(Form("(nPE_rec-nPE_dep)/nPE_dep_%d",energyIndex+1),Form("(nPE_rec-nPE_dep)/nPE_dep_%d",energyIndex+1),EN_NUM,-0.1,0.1);
    ...
    h_Z[energyIndex]= new TH1F(Form("Zrec-Zdep",energyIndex+1),Form("Zrec-Zdep_%d",energyIndex+1),300,-1000,1000); 
    h_V[energyIndex]= new TH1F(Form("Rrec-Rdep",energyIndex+1),Form("Rrec-Rdep_%d:",energyIndex+1),300,-1000,1000); 
    h1_V[energyIndex]= new TH1F(Form("(Rrec-Rdep)/Rdep_%d",energyIndex+1),Form("(Rrec-Rdep)/Rdep_%d",energyIndex+1),TH_NUM,-10,10);
    ...
    h_E_wo[energyIndex]= new TH1F(Form("Erec_wo_%d",energyIndex+1),Form("Erec_%d",energyIndex+1),300,energyIndex,energyIndex*2+2);  
    h_PE_wo[energyIndex]= new TH1F(Form("h_PE_wo_%d",energyIndex+1),Form("total_PE_%d",energyIndex+1),300,(energyIndex)*1300., (energyIndex*2+2)*1300.);
    h1_E_wo[energyIndex]= new TH1F(Form("(Erec-Edep)/Edep_wo_%d",energyIndex+1),Form("(Erec-Edep)/Edep_%d",energyIndex+1),EN_NUM,-0.3,0.3);
    h1_PE_wo[energyIndex]= new TH1F(Form("(nPE_rec-nPE_dep)/nPE_dep_wo_%d",energyIndex+1),Form("(nPE_rec-nPE_dep)/nPE_dep_%d",energyIndex+1),EN_NUM,-0.1,0.1);
    th2_E_wo[energyIndex]= new TH2D(Form("(Erec-Edep)/Edep vs Rdep^{3}_wo",energyIndex+1),Form("(Erec-Edep)/Edep vs Rdep^{3}_wo_%d",energyIndex+1),EN_NUM,-0,6000,EN_NUM,-1,1);
    th3_E_wo[energyIndex]= new TH2D(Form("(Erec-Edep)/Edep vs Edep_wo",energyIndex+1),Form("(Erec-Edep)/Edep vs Edep_wo_%d",energyIndex+1),EN_NUM,0,10,EN_NUM,-1,1);

    h_Z_wo[energyIndex]= new TH1F(Form("Zrec-Zdep_wo",energyIndex+1),Form("Zrec-Zdep_%d",energyIndex+1),300,-1000,1000);
    h_V_wo[energyIndex]= new TH1F(Form("Rrec-Rdep_wo",energyIndex+1),Form("Rrec-Rdep_%d:",energyIndex+1),300,-1000,1000);
    h1_V_wo[energyIndex]= new TH1F(Form("(Rrec-Rdep)/Rdep_wo_%d",energyIndex+1),Form("(Rrec-Rdep)/Rdep_%d",energyIndex+1),TH_NUM,-10,10);
    th2_V_wo[energyIndex]= new TH2D(Form("(Rrec-Rdep)/Rdep vs Rdep^{3}_wo",energyIndex+1),Form("(Rrec-Rdep)/Rdep vs Rdep^{3}_wo_%d",energyIndex+1),TH_NUM,-0,6000,TH_NUM,-1,1);
    th3_V_wo[energyIndex]= new TH2D(Form("(Rrec-Rdep)/Rdep vs Edep_wo",energyIndex+1),Form("(Rrec-Rdep)/Rdep vs Edep_wo_%d",energyIndex+1),TH_NUM,0,10,TH_NUM,-1,1); 
    ...
    TChain ch_rec_wo("Event/RecEvent/RecHeader");
       for(int j=0;j<jobNum;j++){
        ...
        h_Z_wo[energyIndex]->Fit("gaus","W","C",-1000,1000);
        ...
        h_Z[energyIndex]->Fit("gaus","W","C",-1000,1000);
        h_Z[energyIndex]->GetXaxis()->SetTitle("Zrec-Zdep");     
       
        h_V_wo[energyIndex]->Fit("gaus","W","C",-1000,1000);
        ...
        h_V[energyIndex]->Fit("gaus","W","C",-1000,1000);     
        h_V[energyIndex]->GetXaxis()->SetTitle("Rrec-Rdep");   

        h_PE_wo[energyIndex]-> Fit("gaus","W","C",(energyIndex)*1300., (energyIndex*2+2)*1300.);
        TF1  *fit_PE_wo =  (TF1*)h_PE_wo[energyIndex]->GetFunction("gaus");
             fit_PE_wo->SetLineColor(3);
        h1_PE_wo[energyIndex]-> Fit("gaus","W","C",-0.1,0.1);
            TF1  *fit1_PE_wo =  (TF1*)h1_PE_wo[energyIndex]->GetFunction("gaus");
             fit1_PE_wo->SetLineColor(3);
        h_PE[energyIndex]-> Fit("gaus","W","C",(energyIndex)*1300., (energyIndex*2+2)*1300.);
        h1_PE[energyIndex]-> Fit("gaus","W","C",-0.1,0.1);

        h_E_wo[energyIndex]->Fit("gaus","W","C",energyIndex,energyIndex*2+2);
        TF1  *fit_E_wo =  (TF1*)h_E_wo[energyIndex]->GetFunction("gaus");
             fit_E_wo->SetLineColor(3);    
        h_E[energyIndex]->Fit("gaus","W","C",energyIndex,energyIndex*2+2);
        h_E[energyIndex]->GetXaxis()->SetTitle("Erec");
     
        h1_V_wo[energyIndex]->Fit("gaus","W","C",-10,10);
        ...
        h1_V[energyIndex]->Fit("gaus","W","C",-10,10);
        h1_V[energyIndex]->GetXaxis()->SetTitle("(Rrec-Rdep)/Rdep");
 
        h1_E_wo[energyIndex]->Fit("gaus","W","C",-0.3,0.3);
        ...
        h1_E[energyIndex]->Fit("gaus","W","C",-0.3,0.3);
