...
#ifndef DAEDsG4Cerenkov_h
#define DAEDsG4Cerenkov_h 1
...
class DAEDsG4Cerenkov : public G4VProcess
{
...
public: // Without description
	...
	DAEDsG4Cerenkov(const G4String& processName = "Cerenkov", 
...
inline 
G4bool DAEDsG4Cerenkov::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void DAEDsG4Cerenkov::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
void DAEDsG4Cerenkov::SetMaxBetaChangePerStep(const G4double value)
{
        fMaxBetaChange = value*perCent;
}

inline
void DAEDsG4Cerenkov::SetMaxNumPhotonsPerStep(const G4int NumPhotons) 
{ 
	fMaxPhotons = NumPhotons;
}

inline
void DAEDsG4Cerenkov::DumpPhysicsTable() const
{
...
inline
G4PhysicsTable* DAEDsG4Cerenkov::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* DAEDsG4Cerenkov_h */
