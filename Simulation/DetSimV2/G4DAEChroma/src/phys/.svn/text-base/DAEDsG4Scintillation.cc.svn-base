...
//-------------------------------------------------------------------
// DAEDsG4Scintillation is a class modified from G4Scintillation
...
DAEDsG4Scintillation::DAEDsG4Scintillation(const G4String& processName,
                                     G4ProcessType type)
    ...
    , alphaSlowerTime(0) , alphaSlowerRatio(0)
{
    ...
    //verboseLevel = 2;
    //G4cout << " DAEDsG4Scintillation set verboseLevel by hand to " << verboseLevel << G4endl;
...
DAEDsG4Scintillation::~DAEDsG4Scintillation() 
{
...
//
G4VParticleChange*
DAEDsG4Scintillation::AtRestDoIt(const G4Track& aTrack, const G4Step& aStep)

// This routine simply calls the equivalent PostStepDoIt since all the
// necessary information resides in aStep.GetTotalEnergyDeposit()

{
    return DAEDsG4Scintillation::PostStepDoIt(aTrack, aStep);
}
...
//
G4VParticleChange*
DAEDsG4Scintillation::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
...
///////////////////////////////////////////////////////////////////////////////
    ...
    // == get the Step List ==
    G4DAEScintillationStepList* ssl = daemgr->getSSL();
...
void DAEDsG4Scintillation::BuildThePhysicsTable()
{
...
G4double DAEDsG4Scintillation::GetMeanFreePath(const G4Track&,
                                            G4double ,
...
G4double DAEDsG4Scintillation::GetMeanLifeTime(const G4Track&,
                                            G4ForceCondition* condition)
{
    *condition = Forced;
