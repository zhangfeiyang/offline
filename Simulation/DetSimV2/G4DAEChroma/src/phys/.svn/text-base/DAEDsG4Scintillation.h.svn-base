...
#ifndef DAEDsG4Scintillation_h
#define DAEDsG4Scintillation_h 1
...
class DAEDsG4Scintillation : public G4VRestDiscreteProcess, public G4UImessenger
...
private:
	...
	// DAEDsG4Scintillation& operator=(const DAEDsG4Scintillation &right);
...
public: // Without description
	...
	DAEDsG4Scintillation(const G4String& processName = "Scintillation",
                          G4ProcessType type = fElectromagnetic);

	// DAEDsG4Scintillation(const DAEDsG4Scintillation &right);
...
public: // With description
        ...
        // DAEDsG4Scintillation Process has both PostStepDoIt (for energy 
...
inline 
G4bool DAEDsG4Scintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void DAEDsG4Scintillation::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool DAEDsG4Scintillation::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void DAEDsG4Scintillation::SetScintillationYieldFactor(const G4double yieldfactor)
{
...
inline
G4double DAEDsG4Scintillation::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline 
void DAEDsG4Scintillation::SetUseFastMu300nsTrick(const G4bool fastMu300nsTrick)
{
        FastMu300nsTrick = fastMu300nsTrick;
}

inline 
G4bool DAEDsG4Scintillation::GetUseFastMu300nsTrick() const
{
...
inline
void DAEDsG4Scintillation::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double DAEDsG4Scintillation::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

inline
G4PhysicsTable* DAEDsG4Scintillation::GetSlowIntegralTable() const
{
        return theSlowIntegralTable;
}

inline
G4PhysicsTable* DAEDsG4Scintillation::GetFastIntegralTable() const
{
        return theFastIntegralTable;
}

inline
G4PhysicsTable* DAEDsG4Scintillation::GetReemissionIntegralTable() const
{
 	return theReemissionIntegralTable;
}

inline
void DAEDsG4Scintillation::DumpPhysicsTable() const
{
