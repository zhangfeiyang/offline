...
#ifndef DAEDSPHYSCONSOPTICAL_H
#define DAEDSPHYSCONSOPTICAL_H

#include "G4VPhysicsConstructor.hh"
#include "SniperKernel/ToolBase.h"

class DAEDsPhysConsOptical : public G4VPhysicsConstructor
                        , public ToolBase
{

public:

    DAEDsPhysConsOptical(const G4String& name = "optical");
                     
    virtual ~DAEDsPhysConsOptical();
...
private:
    ...
    // See DAEDsG4Cerenkov and Doc 3925 for details
    bool m_applyWaterQe;
