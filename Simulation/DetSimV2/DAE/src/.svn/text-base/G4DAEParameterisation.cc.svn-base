...
// ********************************************************************
//
// $Id: G4DAEParameterisation.cc,v 1.11 2008/07/16 15:46:34 gcosmo Exp $
// GEANT4 tag $Name: geant4-09-02 $
//
// class G4DAEParameterisation Implementation
//
// History:
...
G4int G4DAEParameterisation::GetSize() const
{
   return (G4int)parameterList.size();
}

void G4DAEParameterisation::AddParameter(const PARAMETER& newParameter)
{
   parameterList.push_back(newParameter);
}

void G4DAEParameterisation::
...
{
   G4Exception("G4DAEParameterisation::ComputeDimensions()",
