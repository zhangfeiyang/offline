...
// ********************************************************************
//
// $Id: G4DAEReadSetup.cc,v 1.9 2008/07/16 15:46:34 gcosmo Exp $
// GEANT4 tag $Name: geant4-09-02 $
//
// class G4DAEReadSetup Implementation
//
...
G4String G4DAEReadSetup::GetSetup(const G4String& ref)
{
   ...
   if (setupMap.find(ref) == setupMap.end())
   {
     ...
     G4Exception("G4DAEReadSetup::getSetup()", "ReadError",
...
void G4DAEReadSetup::SetupRead(const xercesc::DOMElement* const element)
{
   G4cout << "G4DAE: Reading setup..." << G4endl;
