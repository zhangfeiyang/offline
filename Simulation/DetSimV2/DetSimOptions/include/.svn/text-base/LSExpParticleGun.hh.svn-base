...
//
//
// $Id: LSExpParticleGun.hh,v 1.11 2007/11/07 17:13:19 asaim Exp $
// GEANT4 tag $Name: geant4-09-02-beta-01 $
//

#ifndef LSExpParticleGun_h
#define LSExpParticleGun_h 1
...
// particle. But, LSExpParticleGun does NOT have any way of randomization. Instead, the user's
...
class LSExpParticleGun:public G4VPrimaryGenerator
{
  public: // with description
     LSExpParticleGun();
     LSExpParticleGun(G4int numberofparticles);
     LSExpParticleGun(G4ParticleDefinition * particleDef, 
  ...
  public:
     virtual ~LSExpParticleGun();

  private:
     LSExpParticleGun(const LSExpParticleGun&);
     const LSExpParticleGun & operator=(const LSExpParticleGun&);
     G4int operator==(const LSExpParticleGun&) const;
     G4int operator!=(const LSExpParticleGun&) const;
