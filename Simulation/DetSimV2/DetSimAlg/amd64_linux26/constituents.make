...
#cmt_local_tagfile = $(DetSimAlg_tag).make
cmt_local_tagfile = $(bin)$(DetSimAlg_tag).make
...
DetSimAlg_extratags = -tag_add=target_DetSimAlg
...
not_DetSimAlgcompile_dependencies = { n=0; for p in $?; do m=0; for d in $(DetSimAlgcompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
DetSimAlgdirs :
	@if test ! -d $(bin)DetSimAlg; then $(mkdir) -p $(bin)DetSimAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)DetSimAlg
else
DetSimAlgdirs : ;
endif
...
ifndef QUICK
$(cmt_local_DetSimAlg_makefile) : $(DetSimAlgcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building DetSimAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DetSimAlg_extratags) build constituent_config -out=$(cmt_local_DetSimAlg_makefile) DetSimAlg
else
$(cmt_local_DetSimAlg_makefile) : $(DetSimAlgcompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DetSimAlg) ] || \
	  [ ! -f $(cmt_final_setup_DetSimAlg) ] || \
	  $(not_DetSimAlgcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building DetSimAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(DetSimAlg_extratags) build constituent_config -out=$(cmt_local_DetSimAlg_makefile) DetSimAlg; \
	  fi
endif
...
$(cmt_local_DetSimAlg_makefile) : $(DetSimAlgcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building DetSimAlg.make"; \
	  $(cmtexe) -f=$(bin)DetSimAlg.in -tag=$(tags) $(DetSimAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_DetSimAlg_makefile) DetSimAlg
else
$(cmt_local_DetSimAlg_makefile) : $(DetSimAlgcompile_dependencies) $(cmt_build_library_linksstamp) $(bin)DetSimAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_DetSimAlg) ] || \
	  [ ! -f $(cmt_final_setup_DetSimAlg) ] || \
	  $(not_DetSimAlgcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(DetSimAlg_extratags) build constituent_makefile -out=$(cmt_local_DetSimAlg_makefile) DetSimAlg

DetSimAlg :: DetSimAlgcompile DetSimAlginstall ;

ifdef cmt_DetSimAlg_has_prototypes

DetSimAlgprototype : $(DetSimAlgprototype_dependencies) $(cmt_local_DetSimAlg_makefile) dirs DetSimAlgdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_DetSimAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DetSimAlg_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_DetSimAlg_makefile) $@
	$(echo) "(constituents.make) $@ done"

DetSimAlgcompile : DetSimAlgprototype

endif

DetSimAlgcompile : $(DetSimAlgcompile_dependencies) $(cmt_local_DetSimAlg_makefile) dirs DetSimAlgdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_DetSimAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DetSimAlg_makefile) $@; \
	  fi
...
DetSimAlgclean :: $(DetSimAlgclean_dependencies) ##$(cmt_local_DetSimAlg_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_DetSimAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DetSimAlg_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_DetSimAlg_makefile) DetSimAlgclean

##	  /bin/rm -f $(cmt_local_DetSimAlg_makefile) $(bin)DetSimAlg_dependencies.make

install :: DetSimAlginstall ;

DetSimAlginstall :: DetSimAlgcompile $(DetSimAlg_dependencies) $(cmt_local_DetSimAlg_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_DetSimAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DetSimAlg_makefile) $@; \
	  fi
...
$(foreach d,$(DetSimAlg_dependencies),$(eval $(d)uninstall_dependencies += DetSimAlguninstall))

DetSimAlguninstall : $(DetSimAlguninstall_dependencies) ##$(cmt_local_DetSimAlg_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_DetSimAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_DetSimAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_DetSimAlg_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: DetSimAlguninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ DetSimAlg"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ DetSimAlg done"
endif
...
cmt_local_tagfile_make = $(bin)$(DetSimAlg_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(DetSimAlg_tag).make
