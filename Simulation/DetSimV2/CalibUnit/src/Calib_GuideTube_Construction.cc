...
Calib_GuideTube_Construction::Calib_GuideTube_Construction(const std::string& name)
	...
	,solidGT(0),logicGT(0),physiGT(0)
	,solidCable(0),logicCable(0),physiCable(0)
	,Teflon(0),Vacuum(0)
{
...
void
Calib_GuideTube_Construction::makeGTLogical() {
    solidGT = new G4Torus("sGT",
                                    8*mm,
                                    9.45*mm,
                                    17.836*m,    //different data in inner and outer tube.
                                    92.0*deg,
    ...
    logicGT = new G4LogicalVolume(solidGT,
                                        Teflon,   //   water
                                        "lGT",
                                        0,
                                        0,
...
void
Calib_GuideTube_Construction::makeGTPhysical() {
    physiGT = new G4PVPlacement(0,
									  G4ThreeVector(0,0,0),
                                      logicGT,    // its logical volume 
                                      "pGT",       // its name
                                      logicSurftube,  // its mother  volume
                                      false,           // no boolean operations
                                      0);              // no particular field
...
void
Calib_GuideTube_Construction::makeCableLogical() {
    solidCable = new G4Torus("sCable",
                                    0*mm,
                                    0.5*mm,
                                    17.836*m,    //different data in inner and outer tube.
                                    92.0*deg,
    ...
    logicCable = new G4LogicalVolume(solidCable,
                                        Steel,   //   water
                                        "lCable",
                                        0,
                                        0,
...
void
Calib_GuideTube_Construction::makeCablePhysical() {
    physiCable = new G4PVPlacement(0,
									  G4ThreeVector(0,0,0),
                                      logicCable,    // its logical volume 
                                      "pCable",       // its name
                                      logicvacSurftube,  // its mother  volume
                                      false,           // no boolean operations
                                      0);              // no particular field
}
