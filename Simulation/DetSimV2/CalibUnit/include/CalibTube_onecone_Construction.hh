#ifndef CalibTube_onecone_Construction_hh
#define CalibTube_onecone_Construction_hh
...
class CalibTube_onecone_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_onecone_Construction(const std::string& name);
    ~CalibTube_onecone_Construction();
