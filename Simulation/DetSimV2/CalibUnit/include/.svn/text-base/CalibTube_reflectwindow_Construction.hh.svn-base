#ifndef CalibTube_reflectwindow_Construction_hh
#define CalibTube_reflectwindow_Construction_hh
...
class CalibTube_reflectwindow_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_reflectwindow_Construction(const std::string& name);
    ~CalibTube_reflectwindow_Construction();
