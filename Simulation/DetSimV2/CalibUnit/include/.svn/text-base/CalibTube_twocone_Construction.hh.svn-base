#ifndef CalibTube_twocone_Construction_hh
#define CalibTube_twocone_Construction_hh
...
class CalibTube_twocone_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_twocone_Construction(const std::string& name);
    ~CalibTube_twocone_Construction();
