#ifndef CalibTube_flatwindow_Construction_hh
#define CalibTube_flatwindow_Construction_hh
...
class CalibTube_flatwindow_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_flatwindow_Construction(const std::string& name);
    ~CalibTube_flatwindow_Construction();
