#ifndef CalibTubeConstruction_hh
#define CalibTubeConstruction_hh
...
class CalibTubeConstruction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTubeConstruction(const std::string& name);
    ~CalibTubeConstruction();
