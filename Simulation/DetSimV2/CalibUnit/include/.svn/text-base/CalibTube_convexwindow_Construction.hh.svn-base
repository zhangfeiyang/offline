#ifndef CalibTube_convexwindow_Construction_hh
#define CalibTube_convexwindow_Construction_hh
...
class CalibTube_convexwindow_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_convexwindow_Construction(const std::string& name);
    ~CalibTube_convexwindow_Construction();
