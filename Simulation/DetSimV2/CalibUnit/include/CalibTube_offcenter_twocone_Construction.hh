#ifndef CalibTube_offcenter_twocone_Construction_hh
#define CalibTube_offcenter_twocone_Construction_hh
...
class CalibTube_offcenter_twocone_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_offcenter_twocone_Construction(const std::string& name);
    ~CalibTube_offcenter_twocone_Construction();
...
private:
  ...
  // new stuff
    ...
    G4Cons*    vacTube3;
    G4LogicalVolume* logicvacTube3;
    G4VPhysicalVolume* physivacTube3;
