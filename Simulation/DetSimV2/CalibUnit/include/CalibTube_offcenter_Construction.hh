#ifndef CalibTube_offcenter_Construction_hh
#define CalibTube_offcenter_Construction_hh
...
class CalibTube_offcenter_Construction: public IDetElement,
                             public ToolBase{
public:
    G4LogicalVolume* getLV();
    bool inject(std::string motherName, IDetElement* other, IDetElementPos* pos);

    CalibTube_offcenter_Construction(const std::string& name);
    ~CalibTube_offcenter_Construction();
