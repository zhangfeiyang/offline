...
if __name__ == "__main__":
    ...
    if flag_use_gdml_calibtube:
        ...
        detsim0.property("CalibUnitName").set("CalibTube_offcenter_reflectwindow")
    print calibtube
    calibtubeplace = detsimalg.createTool("CalibTubePlacement")
    # FIXME a more general geometry service is needed.
    calibTubeLength1 = 9.3e3; # 17.3m
    calibTubeLength2 = 0.3e3   #  0.3m
    offset_z_in_cd = 17.6e3-(calibTubeLength1+calibTubeLength2)/2.
