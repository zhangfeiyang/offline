...
#ifndef OKDsG4Scintillation_h
#define OKDsG4Scintillation_h 1
...
class OKDsG4Scintillation : public G4VRestDiscreteProcess, public G4UImessenger
...
public: // Without description
	...
	OKDsG4Scintillation(const G4String& processName = "Scintillation",
                          G4ProcessType type = fElectromagnetic);

	// OKDsG4Scintillation(const OKDsG4Scintillation &right);
...
public: // With description
        ...
        // OKDsG4Scintillation Process has both PostStepDoIt (for energy 
...
inline 
G4bool OKDsG4Scintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void OKDsG4Scintillation::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool OKDsG4Scintillation::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void OKDsG4Scintillation::SetScintillationYieldFactor(const G4double yieldfactor)
{
...
inline
G4double OKDsG4Scintillation::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline 
void OKDsG4Scintillation::SetUseFastMu300nsTrick(const G4bool fastMu300nsTrick)
{
        FastMu300nsTrick = fastMu300nsTrick;
}

inline 
G4bool OKDsG4Scintillation::GetUseFastMu300nsTrick() const
{
...
inline
void OKDsG4Scintillation::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double OKDsG4Scintillation::GetScintillationExcitationRatio() const
{
        return ExcitationRatio;
}

inline
G4PhysicsTable* OKDsG4Scintillation::GetSlowIntegralTable() const
{
        return theSlowIntegralTable;
}

inline
G4PhysicsTable* OKDsG4Scintillation::GetFastIntegralTable() const
{
        return theFastIntegralTable;
}

inline
G4PhysicsTable* OKDsG4Scintillation::GetReemissionIntegralTable() const
{
 	return theReemissionIntegralTable;
}

inline
void OKDsG4Scintillation::DumpPhysicsTable() const
{
