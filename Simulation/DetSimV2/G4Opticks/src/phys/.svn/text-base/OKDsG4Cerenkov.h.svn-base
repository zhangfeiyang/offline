...
#ifndef OKDsG4Cerenkov_h
#define OKDsG4Cerenkov_h 1
...
class OKDsG4Cerenkov : public G4VProcess
{
...
public: // Without description
	...
	OKDsG4Cerenkov(const G4String& processName = "Cerenkov", 
...
inline 
G4bool OKDsG4Cerenkov::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void OKDsG4Cerenkov::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
void OKDsG4Cerenkov::SetMaxBetaChangePerStep(const G4double value)
{
        fMaxBetaChange = value*perCent;
}

inline
void OKDsG4Cerenkov::SetMaxNumPhotonsPerStep(const G4int NumPhotons) 
{ 
	fMaxPhotons = NumPhotons;
}

inline
void OKDsG4Cerenkov::DumpPhysicsTable() const
{
...
inline
G4PhysicsTable* OKDsG4Cerenkov::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* OKDsG4Cerenkov_h */
