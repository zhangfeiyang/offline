#ifndef R12860TorusPMTManager_hh
#define R12860TorusPMTManager_hh
...
class R12860TorusPMTManager: public IPMTElement,
                        public ToolBase {
public:
    // Interface
...
private:
    /* solid maker */
    R12860_TorusPMTSolid* m_pmtsolid_maker;
    /* solid related */
    ...
    G4VSolid* innerRe_solid;
    G4VSolid* innerRe2_solid;
    G4Tubs* dynode_solid;
    G4double hh_dynode;
    G4double z_dynode;
    /* logical volumes */
    ...
    G4LogicalVolume* innerRe_log;
    G4LogicalVolume* innerRe2_log;
    ...
    G4PVPlacement* innerRe_phys;
    G4PVPlacement* innerRe2_phys;
...
private:
    ...
    G4OpticalSurface* m_Remirror_opsurf;
