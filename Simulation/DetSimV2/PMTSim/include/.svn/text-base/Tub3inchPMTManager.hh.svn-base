#ifndef Tub3inchPMTManager_hh
#define Tub3inchPMTManager_hh
...
class Tub3inchPMTManager: public IPMTElement,
                          public ToolBase {
public:
    // Interface
...
public:
    // Constructor
    Tub3inchPMTManager(const G4String& plabel);
    ~Tub3inchPMTManager();
private:
    void init();
...
private:
    G4String m_label;
    /* solid maker */
    Tub3inchPMTSolid* m_pmtsolid_maker;
    /* solid related */
