#ifndef R3600PMTManager_hh
#define R3600PMTManager_hh
...
class R3600PMTManager: public IPMTElement {
public:
    // Interface
...
private:
    /* solid related */
    void helper_make_solid(const G4int n_edge,
      const G4double outer_z_edge[],
      const G4double outer_rho_edge[],
      const G4double outer_z_o[],
      G4double r_dynode,     // radius of dynode stack
    ...
    //     + inner1
    //     + inner2
    dywTorusStack* pmt_solid; 
    dywTorusStack* body_solid;
    dywTorusStack* inner_solid;
