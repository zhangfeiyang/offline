...
EvtMixingAlg_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(EvtMixingAlg_use_linkopts)
EvtMixingAlg_use_linkopts=    $(ElecDataStruct_linkopts)  $(SimEventV2_linkopts)  $(ElecEvent_linkopts)  $(InputReviser_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(Identifier_linkopts)  $(RootRandomSvc_linkopts)  $(GlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
...
version=v0
PACKAGE_ROOT=$(EVTMIXINGALGROOT)
srcdir=../src
bin=../$(EvtMixingAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Simulation/ElecSimV3/EvtMixingAlg/amd64_linux26/
project=offline
