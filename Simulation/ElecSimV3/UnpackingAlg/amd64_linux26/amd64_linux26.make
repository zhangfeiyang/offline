...
UnpackingAlg_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(UnpackingAlg_use_linkopts)
UnpackingAlg_use_linkopts=    $(ElecBufferMgrSvc_linkopts)  $(ElecDataStruct_linkopts)  $(SimEventV2_linkopts)  $(ElecEvent_linkopts)  $(InputReviser_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(Identifier_linkopts)  $(RootRandomSvc_linkopts)  $(GlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
...
version=v0
PACKAGE_ROOT=$(UNPACKINGALGROOT)
srcdir=../src
bin=../$(UnpackingAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Simulation/ElecSimV3/UnpackingAlg/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(UnpackingAlg_linkopts)  $(ElecBufferMgrSvc_linkopts)  $(ElecDataStruct_linkopts)  $(SimEventV2_linkopts)  $(ElecEvent_linkopts)  $(InputReviser_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(Identifier_linkopts)  $(RootRandomSvc_linkopts)  $(GlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(ElecBufferMgrSvc_root)/cmt/requirements $(ElecDataStruct_root)/cmt/requirements $(SimEventV2_root)/cmt/requirements $(ElecEvent_root)/cmt/requirements $(InputReviser_root)/cmt/requirements $(BufferMemMgr_root)/cmt/requirements $(RootIOSvc_root)/cmt/requirements $(RootIOUtil_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(DataRegistritionSvc_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(Identifier_root)/cmt/requirements $(RootRandomSvc_root)/cmt/requirements $(GlobalTimeSvc_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(Context_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements 
use_includes= $(ppcmd)"$(ElecBufferMgrSvc_root)/src" $(ppcmd)"$(ElecDataStruct_root)/src" $(ppcmd)"$(SimEventV2_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/SimEventV2/" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/SimEventV2/Event" $(ppcmd)"$(ElecEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/ElecEvent/Event" $(ppcmd)"$(InputReviser_root)/src" $(ppcmd)"$(BufferMemMgr_root)/src" $(ppcmd)"$(RootIOSvc_root)/src" $(ppcmd)"$(RootIOUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/RootIO/RootIOUtil/RootIOUtil" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(DataRegistritionSvc_root)/src" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(Identifier_root)/src" $(ppcmd)"$(RootRandomSvc_root)/src" $(ppcmd)"$(GlobalTimeSvc_root)/src" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(Context_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/Context/Context" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" 
use_fincludes= $(use_includes)
use_stamps=  $(UnpackingAlg_stamps)  $(ElecBufferMgrSvc_stamps)  $(ElecDataStruct_stamps)  $(SimEventV2_stamps)  $(ElecEvent_stamps)  $(InputReviser_stamps)  $(BufferMemMgr_stamps)  $(RootIOSvc_stamps)  $(RootIOUtil_stamps)  $(EvtNavigator_stamps)  $(DataRegistritionSvc_stamps)  $(EDMUtil_stamps)  $(Identifier_stamps)  $(RootRandomSvc_stamps)  $(GlobalTimeSvc_stamps)  $(SniperKernel_stamps)  $(BaseEvent_stamps)  $(Context_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps) 
use_cflags=  $(UnpackingAlg_cflags)  $(ElecBufferMgrSvc_cflags)  $(ElecDataStruct_cflags)  $(SimEventV2_cflags)  $(ElecEvent_cflags)  $(InputReviser_cflags)  $(BufferMemMgr_cflags)  $(RootIOSvc_cflags)  $(RootIOUtil_cflags)  $(EvtNavigator_cflags)  $(DataRegistritionSvc_cflags)  $(EDMUtil_cflags)  $(Identifier_cflags)  $(RootRandomSvc_cflags)  $(GlobalTimeSvc_cflags)  $(SniperKernel_cflags)  $(BaseEvent_cflags)  $(Context_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(UnpackingAlg_pp_cflags)  $(ElecBufferMgrSvc_pp_cflags)  $(ElecDataStruct_pp_cflags)  $(SimEventV2_pp_cflags)  $(ElecEvent_pp_cflags)  $(InputReviser_pp_cflags)  $(BufferMemMgr_pp_cflags)  $(RootIOSvc_pp_cflags)  $(RootIOUtil_pp_cflags)  $(EvtNavigator_pp_cflags)  $(DataRegistritionSvc_pp_cflags)  $(EDMUtil_pp_cflags)  $(Identifier_pp_cflags)  $(RootRandomSvc_pp_cflags)  $(GlobalTimeSvc_pp_cflags)  $(SniperKernel_pp_cflags)  $(BaseEvent_pp_cflags)  $(Context_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(UnpackingAlg_cppflags)  $(ElecBufferMgrSvc_cppflags)  $(ElecDataStruct_cppflags)  $(SimEventV2_cppflags)  $(ElecEvent_cppflags)  $(InputReviser_cppflags)  $(BufferMemMgr_cppflags)  $(RootIOSvc_cppflags)  $(RootIOUtil_cppflags)  $(EvtNavigator_cppflags)  $(DataRegistritionSvc_cppflags)  $(EDMUtil_cppflags)  $(Identifier_cppflags)  $(RootRandomSvc_cppflags)  $(GlobalTimeSvc_cppflags)  $(SniperKernel_cppflags)  $(BaseEvent_cppflags)  $(Context_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(UnpackingAlg_pp_cppflags)  $(ElecBufferMgrSvc_pp_cppflags)  $(ElecDataStruct_pp_cppflags)  $(SimEventV2_pp_cppflags)  $(ElecEvent_pp_cppflags)  $(InputReviser_pp_cppflags)  $(BufferMemMgr_pp_cppflags)  $(RootIOSvc_pp_cppflags)  $(RootIOUtil_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(DataRegistritionSvc_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(Identifier_pp_cppflags)  $(RootRandomSvc_pp_cppflags)  $(GlobalTimeSvc_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(Context_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(UnpackingAlg_fflags)  $(ElecBufferMgrSvc_fflags)  $(ElecDataStruct_fflags)  $(SimEventV2_fflags)  $(ElecEvent_fflags)  $(InputReviser_fflags)  $(BufferMemMgr_fflags)  $(RootIOSvc_fflags)  $(RootIOUtil_fflags)  $(EvtNavigator_fflags)  $(DataRegistritionSvc_fflags)  $(EDMUtil_fflags)  $(Identifier_fflags)  $(RootRandomSvc_fflags)  $(GlobalTimeSvc_fflags)  $(SniperKernel_fflags)  $(BaseEvent_fflags)  $(Context_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(UnpackingAlg_pp_fflags)  $(ElecBufferMgrSvc_pp_fflags)  $(ElecDataStruct_pp_fflags)  $(SimEventV2_pp_fflags)  $(ElecEvent_pp_fflags)  $(InputReviser_pp_fflags)  $(BufferMemMgr_pp_fflags)  $(RootIOSvc_pp_fflags)  $(RootIOUtil_pp_fflags)  $(EvtNavigator_pp_fflags)  $(DataRegistritionSvc_pp_fflags)  $(EDMUtil_pp_fflags)  $(Identifier_pp_fflags)  $(RootRandomSvc_pp_fflags)  $(GlobalTimeSvc_pp_fflags)  $(SniperKernel_pp_fflags)  $(BaseEvent_pp_fflags)  $(Context_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags) 
use_libraries= $(ElecBufferMgrSvc_libraries)  $(ElecDataStruct_libraries)  $(SimEventV2_libraries)  $(ElecEvent_libraries)  $(InputReviser_libraries)  $(BufferMemMgr_libraries)  $(RootIOSvc_libraries)  $(RootIOUtil_libraries)  $(EvtNavigator_libraries)  $(DataRegistritionSvc_libraries)  $(EDMUtil_libraries)  $(Identifier_libraries)  $(RootRandomSvc_libraries)  $(GlobalTimeSvc_libraries)  $(SniperKernel_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(Context_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries) 
fincludes= $(includes)
UnpackingAlg_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
UnpackingAlg_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= UnpackingAlg UnpackingAlg_python 
all_constituents= $(constituents)
constituentsclean= UnpackingAlg_pythonclean UnpackingAlgclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
UnpackingAlgprototype_dependencies= $(UnpackingAlgcompile_dependencies)
