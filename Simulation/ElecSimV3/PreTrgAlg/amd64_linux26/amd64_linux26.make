...
PreTrgAlg_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(PreTrgAlg_use_linkopts)
PreTrgAlg_use_linkopts=    $(ElecBufferMgrSvc_linkopts)  $(ElecDataStruct_linkopts)  $(SimEventV2_linkopts)  $(ElecEvent_linkopts)  $(InputReviser_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(Identifier_linkopts)  $(RootRandomSvc_linkopts)  $(GlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
PreTrgAlg_stamps=${PRETRGALGROOT}/${BINDIR}/PreTrgAlg.stamp 
PreTrgAlg_linker_library=PreTrgAlg
tag=amd64_linux26
package=PreTrgAlg
version=v0
PACKAGE_ROOT=$(PRETRGALGROOT)
srcdir=../src
bin=../$(PreTrgAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Simulation/ElecSimV3/PreTrgAlg/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(PreTrgAlg_linkopts)  $(ElecBufferMgrSvc_linkopts)  $(ElecDataStruct_linkopts)  $(SimEventV2_linkopts)  $(ElecEvent_linkopts)  $(InputReviser_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(Identifier_linkopts)  $(RootRandomSvc_linkopts)  $(GlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
...
fincludes= $(includes)
PreTrgAlg_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PreTrgAlg_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= PreTrgAlg PreTrgAlg_python 
all_constituents= $(constituents)
constituentsclean= PreTrgAlg_pythonclean PreTrgAlgclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
PreTrgAlgprototype_dependencies= $(PreTrgAlgcompile_dependencies)
