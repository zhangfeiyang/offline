...
tags      = $(tag),$(CMTEXTRATAGS),target_PreTrgAlg_python

PreTrgAlg_tag = $(tag)

#cmt_local_tagfile_PreTrgAlg_python = $(PreTrgAlg_tag)_PreTrgAlg_python.make
...
#cmt_local_tagfile_PreTrgAlg_python = $(PreTrgAlg_tag).make
cmt_local_tagfile_PreTrgAlg_python = $(bin)$(PreTrgAlg_tag).make

endif

include $(cmt_local_tagfile_PreTrgAlg_python)
#-include $(cmt_local_tagfile_PreTrgAlg_python)

ifdef cmt_PreTrgAlg_python_has_target_tag

cmt_final_setup_PreTrgAlg_python = $(bin)setup_PreTrgAlg_python.make
cmt_dependencies_in_PreTrgAlg_python = $(bin)dependencies_PreTrgAlg_python.in
#cmt_final_setup_PreTrgAlg_python = $(bin)PreTrgAlg_PreTrgAlg_pythonsetup.make
cmt_local_PreTrgAlg_python_makefile = $(bin)PreTrgAlg_python.make

else

cmt_final_setup_PreTrgAlg_python = $(bin)setup.make
cmt_dependencies_in_PreTrgAlg_python = $(bin)dependencies.in
#cmt_final_setup_PreTrgAlg_python = $(bin)PreTrgAlgsetup.make
cmt_local_PreTrgAlg_python_makefile = $(bin)PreTrgAlg_python.make
...
help ::
	$(echo) 'PreTrgAlg_python'

binobj = 
ifdef STRUCTURED_OUTPUT
binobj = PreTrgAlg_python/
#PreTrgAlg_python::
...
PreTrgAlg_python :: PreTrgAlg_pythoninstall

install :: PreTrgAlg_pythoninstall

PreTrgAlg_pythoninstall :: $(install_python_dir)
	@if [ ! "$(installarea)" = "" ] ; then\
...
PreTrgAlg_pythonclean :: PreTrgAlg_pythonuninstall

uninstall :: PreTrgAlg_pythonuninstall

PreTrgAlg_pythonuninstall ::
...
ifndef PEDANTIC
.DEFAULT::
	$(echo) "(PreTrgAlg_python.make) $@: No rule for such target" >&2
else
.DEFAULT::
	$(error PEDANTIC: $@: No rule for such target)
endif

PreTrgAlg_pythonclean ::
