...
includes= $(ppcmd)"$(GlobalTimeSvc_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
GlobalTimeSvc_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GlobalTimeSvc_use_linkopts)
GlobalTimeSvc_use_linkopts=    $(SniperKernel_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
GlobalTimeSvc_stamps=${GLOBALTIMESVCROOT}/${BINDIR}/GlobalTimeSvc.stamp 
GlobalTimeSvc_linker_library=GlobalTimeSvc
tag=amd64_linux26
package=GlobalTimeSvc
version=v0
PACKAGE_ROOT=$(GLOBALTIMESVCROOT)
srcdir=../src
bin=../$(GlobalTimeSvc_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Simulation/ElecSimV3/GlobalTimeSvc/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(GlobalTimeSvc_linkopts)  $(SniperKernel_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts) 
...
use_stamps=  $(GlobalTimeSvc_stamps)  $(SniperKernel_stamps)  $(Context_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps) 
use_cflags=  $(GlobalTimeSvc_cflags)  $(SniperKernel_cflags)  $(Context_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(GlobalTimeSvc_pp_cflags)  $(SniperKernel_pp_cflags)  $(Context_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(GlobalTimeSvc_cppflags)  $(SniperKernel_cppflags)  $(Context_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(GlobalTimeSvc_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(Context_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(GlobalTimeSvc_fflags)  $(SniperKernel_fflags)  $(Context_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(GlobalTimeSvc_pp_fflags)  $(SniperKernel_pp_fflags)  $(Context_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags) 
...
fincludes= $(includes)
GlobalTimeSvc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GlobalTimeSvc_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= GlobalTimeSvc install_more_includes GlobalTimeSvc_python 
all_constituents= $(constituents)
constituentsclean= GlobalTimeSvc_pythonclean install_more_includesclean GlobalTimeSvcclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
GlobalTimeSvcprototype_dependencies= $(GlobalTimeSvccompile_dependencies)
