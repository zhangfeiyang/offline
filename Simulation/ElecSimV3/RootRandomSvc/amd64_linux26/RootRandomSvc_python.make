...
tags      = $(tag),$(CMTEXTRATAGS),target_RootRandomSvc_python

RootRandomSvc_tag = $(tag)

#cmt_local_tagfile_RootRandomSvc_python = $(RootRandomSvc_tag)_RootRandomSvc_python.make
...
#cmt_local_tagfile_RootRandomSvc_python = $(RootRandomSvc_tag).make
cmt_local_tagfile_RootRandomSvc_python = $(bin)$(RootRandomSvc_tag).make

endif

include $(cmt_local_tagfile_RootRandomSvc_python)
#-include $(cmt_local_tagfile_RootRandomSvc_python)

ifdef cmt_RootRandomSvc_python_has_target_tag

cmt_final_setup_RootRandomSvc_python = $(bin)setup_RootRandomSvc_python.make
cmt_dependencies_in_RootRandomSvc_python = $(bin)dependencies_RootRandomSvc_python.in
#cmt_final_setup_RootRandomSvc_python = $(bin)RootRandomSvc_RootRandomSvc_pythonsetup.make
cmt_local_RootRandomSvc_python_makefile = $(bin)RootRandomSvc_python.make

else

cmt_final_setup_RootRandomSvc_python = $(bin)setup.make
cmt_dependencies_in_RootRandomSvc_python = $(bin)dependencies.in
#cmt_final_setup_RootRandomSvc_python = $(bin)RootRandomSvcsetup.make
cmt_local_RootRandomSvc_python_makefile = $(bin)RootRandomSvc_python.make
...
help ::
	$(echo) 'RootRandomSvc_python'

binobj = 
ifdef STRUCTURED_OUTPUT
binobj = RootRandomSvc_python/
#RootRandomSvc_python::
...
RootRandomSvc_python :: RootRandomSvc_pythoninstall

install :: RootRandomSvc_pythoninstall

RootRandomSvc_pythoninstall :: $(install_python_dir)
	@if [ ! "$(installarea)" = "" ] ; then\
...
RootRandomSvc_pythonclean :: RootRandomSvc_pythonuninstall

uninstall :: RootRandomSvc_pythonuninstall

RootRandomSvc_pythonuninstall ::
...
ifndef PEDANTIC
.DEFAULT::
	$(echo) "(RootRandomSvc_python.make) $@: No rule for such target" >&2
else
.DEFAULT::
	$(error PEDANTIC: $@: No rule for such target)
endif

RootRandomSvc_pythonclean ::
