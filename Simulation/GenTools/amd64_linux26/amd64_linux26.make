...
includes= $(ppcmd)"$(GenTools_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
GenTools_use_linkopts= -lEG     $(RootWriter_linkopts)  $(RandomSvc_linkopts)  $(MCGlobalTimeSvc_linkopts)  $(EvtNavigator_linkopts)  $(GenEventV2_linkopts)  $(EDMUtil_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(HepMC_linkopts)  $(CLHEP_linkopts)  $(Geant4_linkopts) 
GenTools_linkopts= -lGenTools 
GenTools_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GenTools_use_linkopts)
GenTools_stamps=${GENTOOLSROOT}/${BINDIR}/GenTools.stamp 
GenTools_linker_library=GenTools
tag=amd64_linux26
package=GenTools
version=v0
PACKAGE_ROOT=$(GENTOOLSROOT)
srcdir=../src
bin=../$(GenTools_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Simulation/GenTools/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(GenTools_linkopts)  $(RootWriter_linkopts)  $(RandomSvc_linkopts)  $(MCGlobalTimeSvc_linkopts)  $(EvtNavigator_linkopts)  $(GenEventV2_linkopts)  $(EDMUtil_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(HepMC_linkopts)  $(CLHEP_linkopts)  $(Geant4_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(RootWriter_root)/cmt/requirements $(RandomSvc_root)/cmt/requirements $(MCGlobalTimeSvc_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(GenEventV2_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(HepMC_root)/cmt/requirements $(CLHEP_root)/cmt/requirements $(Geant4_root)/cmt/requirements 
use_includes= $(ppcmd)"$(RootWriter_root)/src" $(ppcmd)"$(RandomSvc_root)/src" $(ppcmd)"$(MCGlobalTimeSvc_root)/src" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(GenEventV2_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/Event" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(HepMC_root)/src" $(ppcmd)"$(CLHEP_root)/src" $(ppcmd)"$(Geant4_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Release/J17v1r1/ExternalLibs/Geant4/9.4.p04/include/geant4" 
use_fincludes= $(use_includes)
use_stamps=  $(GenTools_stamps)  $(RootWriter_stamps)  $(RandomSvc_stamps)  $(MCGlobalTimeSvc_stamps)  $(EvtNavigator_stamps)  $(GenEventV2_stamps)  $(EDMUtil_stamps)  $(SniperKernel_stamps)  $(BaseEvent_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps)  $(HepMC_stamps)  $(CLHEP_stamps)  $(Geant4_stamps) 
use_cflags=  $(GenTools_cflags)  $(RootWriter_cflags)  $(RandomSvc_cflags)  $(MCGlobalTimeSvc_cflags)  $(EvtNavigator_cflags)  $(GenEventV2_cflags)  $(EDMUtil_cflags)  $(SniperKernel_cflags)  $(BaseEvent_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags)  $(HepMC_cflags)  $(CLHEP_cflags)  $(Geant4_cflags) 
use_pp_cflags=  $(GenTools_pp_cflags)  $(RootWriter_pp_cflags)  $(RandomSvc_pp_cflags)  $(MCGlobalTimeSvc_pp_cflags)  $(EvtNavigator_pp_cflags)  $(GenEventV2_pp_cflags)  $(EDMUtil_pp_cflags)  $(SniperKernel_pp_cflags)  $(BaseEvent_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags)  $(HepMC_pp_cflags)  $(CLHEP_pp_cflags)  $(Geant4_pp_cflags) 
use_cppflags=  $(GenTools_cppflags)  $(RootWriter_cppflags)  $(RandomSvc_cppflags)  $(MCGlobalTimeSvc_cppflags)  $(EvtNavigator_cppflags)  $(GenEventV2_cppflags)  $(EDMUtil_cppflags)  $(SniperKernel_cppflags)  $(BaseEvent_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags)  $(HepMC_cppflags)  $(CLHEP_cppflags)  $(Geant4_cppflags) 
use_pp_cppflags=  $(GenTools_pp_cppflags)  $(RootWriter_pp_cppflags)  $(RandomSvc_pp_cppflags)  $(MCGlobalTimeSvc_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(GenEventV2_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags)  $(HepMC_pp_cppflags)  $(CLHEP_pp_cppflags)  $(Geant4_pp_cppflags) 
use_fflags=  $(GenTools_fflags)  $(RootWriter_fflags)  $(RandomSvc_fflags)  $(MCGlobalTimeSvc_fflags)  $(EvtNavigator_fflags)  $(GenEventV2_fflags)  $(EDMUtil_fflags)  $(SniperKernel_fflags)  $(BaseEvent_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags)  $(HepMC_fflags)  $(CLHEP_fflags)  $(Geant4_fflags) 
use_pp_fflags=  $(GenTools_pp_fflags)  $(RootWriter_pp_fflags)  $(RandomSvc_pp_fflags)  $(MCGlobalTimeSvc_pp_fflags)  $(EvtNavigator_pp_fflags)  $(GenEventV2_pp_fflags)  $(EDMUtil_pp_fflags)  $(SniperKernel_pp_fflags)  $(BaseEvent_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags)  $(HepMC_pp_fflags)  $(CLHEP_pp_fflags)  $(Geant4_pp_fflags) 
use_libraries= $(RootWriter_libraries)  $(RandomSvc_libraries)  $(MCGlobalTimeSvc_libraries)  $(EvtNavigator_libraries)  $(GenEventV2_libraries)  $(EDMUtil_libraries)  $(SniperKernel_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries)  $(HepMC_libraries)  $(CLHEP_libraries)  $(Geant4_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GenTools_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GenTools_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes GenTools GenTools_python 
all_constituents= $(constituents)
constituentsclean= GenTools_pythonclean GenToolsclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
GenToolsprototype_dependencies= $(GenToolscompile_dependencies)
