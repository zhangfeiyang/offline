...
#cmt_local_tagfile = $(RootIOUtil_tag).make
cmt_local_tagfile = $(bin)$(RootIOUtil_tag).make
...
RootIOUtil_extratags = -tag_add=target_RootIOUtil
...
not_RootIOUtilcompile_dependencies = { n=0; for p in $?; do m=0; for d in $(RootIOUtilcompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
RootIOUtildirs :
	@if test ! -d $(bin)RootIOUtil; then $(mkdir) -p $(bin)RootIOUtil; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)RootIOUtil
else
RootIOUtildirs : ;
endif
...
ifndef QUICK
$(cmt_local_RootIOUtil_makefile) : $(RootIOUtilcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building RootIOUtil.make"; \
	  $(cmtexe) -tag=$(tags) $(RootIOUtil_extratags) build constituent_config -out=$(cmt_local_RootIOUtil_makefile) RootIOUtil
else
$(cmt_local_RootIOUtil_makefile) : $(RootIOUtilcompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_RootIOUtil) ] || \
	  [ ! -f $(cmt_final_setup_RootIOUtil) ] || \
	  $(not_RootIOUtilcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building RootIOUtil.make"; \
	  $(cmtexe) -tag=$(tags) $(RootIOUtil_extratags) build constituent_config -out=$(cmt_local_RootIOUtil_makefile) RootIOUtil; \
	  fi
endif
...
$(cmt_local_RootIOUtil_makefile) : $(RootIOUtilcompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building RootIOUtil.make"; \
	  $(cmtexe) -f=$(bin)RootIOUtil.in -tag=$(tags) $(RootIOUtil_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_RootIOUtil_makefile) RootIOUtil
else
$(cmt_local_RootIOUtil_makefile) : $(RootIOUtilcompile_dependencies) $(cmt_build_library_linksstamp) $(bin)RootIOUtil.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_RootIOUtil) ] || \
	  [ ! -f $(cmt_final_setup_RootIOUtil) ] || \
	  $(not_RootIOUtilcompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(RootIOUtil_extratags) build constituent_makefile -out=$(cmt_local_RootIOUtil_makefile) RootIOUtil

RootIOUtil :: RootIOUtilcompile RootIOUtilinstall ;

ifdef cmt_RootIOUtil_has_prototypes

RootIOUtilprototype : $(RootIOUtilprototype_dependencies) $(cmt_local_RootIOUtil_makefile) dirs RootIOUtildirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_RootIOUtil_makefile); then \
	  $(MAKE) -f $(cmt_local_RootIOUtil_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_RootIOUtil_makefile) $@
	$(echo) "(constituents.make) $@ done"

RootIOUtilcompile : RootIOUtilprototype

endif

RootIOUtilcompile : $(RootIOUtilcompile_dependencies) $(cmt_local_RootIOUtil_makefile) dirs RootIOUtildirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_RootIOUtil_makefile); then \
	  $(MAKE) -f $(cmt_local_RootIOUtil_makefile) $@; \
	  fi
...
RootIOUtilclean :: $(RootIOUtilclean_dependencies) ##$(cmt_local_RootIOUtil_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_RootIOUtil_makefile); then \
	  $(MAKE) -f $(cmt_local_RootIOUtil_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_RootIOUtil_makefile) RootIOUtilclean

##	  /bin/rm -f $(cmt_local_RootIOUtil_makefile) $(bin)RootIOUtil_dependencies.make

install :: RootIOUtilinstall ;

RootIOUtilinstall :: RootIOUtilcompile $(RootIOUtil_dependencies) $(cmt_local_RootIOUtil_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_RootIOUtil_makefile); then \
	  $(MAKE) -f $(cmt_local_RootIOUtil_makefile) $@; \
	  fi
...
$(foreach d,$(RootIOUtil_dependencies),$(eval $(d)uninstall_dependencies += RootIOUtiluninstall))

RootIOUtiluninstall : $(RootIOUtiluninstall_dependencies) ##$(cmt_local_RootIOUtil_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_RootIOUtil_makefile); then \
	  $(MAKE) -f $(cmt_local_RootIOUtil_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_RootIOUtil_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: RootIOUtiluninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ RootIOUtil"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ RootIOUtil done"
endif
...
cmt_local_tagfile_make = $(bin)$(RootIOUtil_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(RootIOUtil_tag).make
