...
RootIOTools_use_linkopts=    $(DataModelRelease_linkopts)  $(GenEventV2_linkopts)  $(SimEventV2_linkopts)  $(ElecEvent_linkopts)  $(RecEvent_linkopts)  $(CalibEvent_linkopts)  $(PhyEvent_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(CLHEPDict_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(HepMC_linkopts)  $(CLHEP_linkopts) 
...
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/RootIO/RootIOTools/amd64_linux26/
project=offline
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(DataModelRelease_root)/cmt/requirements $(GenEventV2_root)/cmt/requirements $(SimEventV2_root)/cmt/requirements $(ElecEvent_root)/cmt/requirements $(RecEvent_root)/cmt/requirements $(CalibEvent_root)/cmt/requirements $(PhyEvent_root)/cmt/requirements $(RootIOSvc_root)/cmt/requirements $(RootIOUtil_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(DataRegistritionSvc_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(CLHEPDict_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(Context_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(HepMC_root)/cmt/requirements $(CLHEP_root)/cmt/requirements 
use_includes= $(ppcmd)"$(DataModelRelease_root)/src" $(ppcmd)"$(GenEventV2_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/Event" $(ppcmd)"$(SimEventV2_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/SimEventV2/" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/SimEventV2/Event" $(ppcmd)"$(ElecEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/ElecEvent/Event" $(ppcmd)"$(RecEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/RecEvent/Event" $(ppcmd)"$(CalibEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/CalibEvent/Event" $(ppcmd)"$(PhyEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/PhyEvent/Event" $(ppcmd)"$(RootIOSvc_root)/src" $(ppcmd)"$(RootIOUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/RootIO/RootIOUtil/RootIOUtil" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(DataRegistritionSvc_root)/src" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(CLHEPDict_root)/src" $(ppcmd)"$(Context_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/Context/Context" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(HepMC_root)/src" $(ppcmd)"$(CLHEP_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(RootIOTools_stamps)  $(DataModelRelease_stamps)  $(GenEventV2_stamps)  $(SimEventV2_stamps)  $(ElecEvent_stamps)  $(RecEvent_stamps)  $(CalibEvent_stamps)  $(PhyEvent_stamps)  $(RootIOSvc_stamps)  $(RootIOUtil_stamps)  $(EvtNavigator_stamps)  $(DataRegistritionSvc_stamps)  $(EDMUtil_stamps)  $(SniperKernel_stamps)  $(BaseEvent_stamps)  $(CLHEPDict_stamps)  $(Context_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps)  $(HepMC_stamps)  $(CLHEP_stamps) 
use_cflags=  $(RootIOTools_cflags)  $(DataModelRelease_cflags)  $(GenEventV2_cflags)  $(SimEventV2_cflags)  $(ElecEvent_cflags)  $(RecEvent_cflags)  $(CalibEvent_cflags)  $(PhyEvent_cflags)  $(RootIOSvc_cflags)  $(RootIOUtil_cflags)  $(EvtNavigator_cflags)  $(DataRegistritionSvc_cflags)  $(EDMUtil_cflags)  $(SniperKernel_cflags)  $(BaseEvent_cflags)  $(CLHEPDict_cflags)  $(Context_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags)  $(HepMC_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(RootIOTools_pp_cflags)  $(DataModelRelease_pp_cflags)  $(GenEventV2_pp_cflags)  $(SimEventV2_pp_cflags)  $(ElecEvent_pp_cflags)  $(RecEvent_pp_cflags)  $(CalibEvent_pp_cflags)  $(PhyEvent_pp_cflags)  $(RootIOSvc_pp_cflags)  $(RootIOUtil_pp_cflags)  $(EvtNavigator_pp_cflags)  $(DataRegistritionSvc_pp_cflags)  $(EDMUtil_pp_cflags)  $(SniperKernel_pp_cflags)  $(BaseEvent_pp_cflags)  $(CLHEPDict_pp_cflags)  $(Context_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags)  $(HepMC_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(RootIOTools_cppflags)  $(DataModelRelease_cppflags)  $(GenEventV2_cppflags)  $(SimEventV2_cppflags)  $(ElecEvent_cppflags)  $(RecEvent_cppflags)  $(CalibEvent_cppflags)  $(PhyEvent_cppflags)  $(RootIOSvc_cppflags)  $(RootIOUtil_cppflags)  $(EvtNavigator_cppflags)  $(DataRegistritionSvc_cppflags)  $(EDMUtil_cppflags)  $(SniperKernel_cppflags)  $(BaseEvent_cppflags)  $(CLHEPDict_cppflags)  $(Context_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags)  $(HepMC_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(RootIOTools_pp_cppflags)  $(DataModelRelease_pp_cppflags)  $(GenEventV2_pp_cppflags)  $(SimEventV2_pp_cppflags)  $(ElecEvent_pp_cppflags)  $(RecEvent_pp_cppflags)  $(CalibEvent_pp_cppflags)  $(PhyEvent_pp_cppflags)  $(RootIOSvc_pp_cppflags)  $(RootIOUtil_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(DataRegistritionSvc_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(CLHEPDict_pp_cppflags)  $(Context_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags)  $(HepMC_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(RootIOTools_fflags)  $(DataModelRelease_fflags)  $(GenEventV2_fflags)  $(SimEventV2_fflags)  $(ElecEvent_fflags)  $(RecEvent_fflags)  $(CalibEvent_fflags)  $(PhyEvent_fflags)  $(RootIOSvc_fflags)  $(RootIOUtil_fflags)  $(EvtNavigator_fflags)  $(DataRegistritionSvc_fflags)  $(EDMUtil_fflags)  $(SniperKernel_fflags)  $(BaseEvent_fflags)  $(CLHEPDict_fflags)  $(Context_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags)  $(HepMC_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(RootIOTools_pp_fflags)  $(DataModelRelease_pp_fflags)  $(GenEventV2_pp_fflags)  $(SimEventV2_pp_fflags)  $(ElecEvent_pp_fflags)  $(RecEvent_pp_fflags)  $(CalibEvent_pp_fflags)  $(PhyEvent_pp_fflags)  $(RootIOSvc_pp_fflags)  $(RootIOUtil_pp_fflags)  $(EvtNavigator_pp_fflags)  $(DataRegistritionSvc_pp_fflags)  $(EDMUtil_pp_fflags)  $(SniperKernel_pp_fflags)  $(BaseEvent_pp_fflags)  $(CLHEPDict_pp_fflags)  $(Context_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags)  $(HepMC_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(DataModelRelease_libraries)  $(GenEventV2_libraries)  $(SimEventV2_libraries)  $(ElecEvent_libraries)  $(RecEvent_libraries)  $(CalibEvent_libraries)  $(PhyEvent_libraries)  $(RootIOSvc_libraries)  $(RootIOUtil_libraries)  $(EvtNavigator_libraries)  $(DataRegistritionSvc_libraries)  $(EDMUtil_libraries)  $(SniperKernel_libraries)  $(BaseEvent_libraries)  $(CLHEPDict_libraries)  $(XmlObjDesc_libraries)  $(Context_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries)  $(HepMC_libraries)  $(CLHEP_libraries) 
fincludes= $(includes)
...
constituents= RootIOTools RootIOTools_python 
all_constituents= $(constituents)
constituentsclean= RootIOTools_pythonclean RootIOToolsclean 
