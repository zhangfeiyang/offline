...
package=JunoTest
version=v0
PACKAGE_ROOT=$(JUNOTESTROOT)
srcdir=../src
bin=../$(JunoTest_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Validation/JunoTest/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(JunoTest_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts) 
...
use_stamps=  $(JunoTest_stamps)  $(SniperPolicy_stamps)  $(ROOT_stamps) 
use_cflags=  $(JunoTest_cflags)  $(SniperPolicy_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(JunoTest_pp_cflags)  $(SniperPolicy_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(JunoTest_cppflags)  $(SniperPolicy_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(JunoTest_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(JunoTest_fflags)  $(SniperPolicy_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(JunoTest_pp_fflags)  $(SniperPolicy_pp_fflags)  $(ROOT_pp_fflags) 
...
fincludes= $(includes)
BasicDistribution_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
BasicDistribution_use_linkopts=  $(JunoTest_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts) 
JunoTest_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= BasicDistribution JunoTest_python 
all_constituents= $(constituents)
constituentsclean= JunoTest_pythonclean BasicDistributionclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
BasicDistributionprototype_dependencies= $(BasicDistributioncompile_dependencies)
