...
package=K40
version=v0
PACKAGE_ROOT=$(K40ROOT)
srcdir=../src
bin=../$(K40_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/RadioActivity/K40/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(K40_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(K40_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(K40_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(K40_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(K40_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(K40_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(K40_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(K40_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
K40_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
K40_use_linkopts=  $(K40_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= K40 
all_constituents= $(constituents)
constituentsclean= K40clean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
K40prototype_dependencies= $(K40compile_dependencies)
