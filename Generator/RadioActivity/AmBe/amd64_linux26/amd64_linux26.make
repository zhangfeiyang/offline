...
package=AmBe
version=v0
PACKAGE_ROOT=$(AMBEROOT)
srcdir=../src
bin=../$(AmBe_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/RadioActivity/AmBe/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(AmBe_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(AmBe_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(AmBe_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(AmBe_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(AmBe_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(AmBe_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(AmBe_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(AmBe_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
AmBe_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
AmBe_use_linkopts=  $(AmBe_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= AmBe 
all_constituents= $(constituents)
constituentsclean= AmBeclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
AmBeprototype_dependencies= $(AmBecompile_dependencies)
