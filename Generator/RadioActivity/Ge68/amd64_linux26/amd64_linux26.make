...
package=Ge68
version=v0
PACKAGE_ROOT=$(GE68ROOT)
srcdir=../src
bin=../$(Ge68_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/RadioActivity/Ge68/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Ge68_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(Ge68_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(Ge68_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(Ge68_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(Ge68_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(Ge68_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(Ge68_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(Ge68_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
Ge68_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Ge68_use_linkopts=  $(Ge68_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= Ge68 
all_constituents= $(constituents)
constituentsclean= Ge68clean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
Ge68prototype_dependencies= $(Ge68compile_dependencies)
