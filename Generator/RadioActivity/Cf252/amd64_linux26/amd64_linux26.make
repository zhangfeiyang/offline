...
package=Cf252
version=v0
PACKAGE_ROOT=$(CF252ROOT)
srcdir=../src
bin=../$(Cf252_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/RadioActivity/Cf252/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Cf252_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(Cf252_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(Cf252_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(Cf252_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(Cf252_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(Cf252_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(Cf252_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(Cf252_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
Cf252_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Cf252_use_linkopts=  $(Cf252_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= Cf252 
all_constituents= $(constituents)
constituentsclean= Cf252clean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
Cf252prototype_dependencies= $(Cf252compile_dependencies)
