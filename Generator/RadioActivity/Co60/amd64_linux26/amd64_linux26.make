...
package=Co60
version=v0
PACKAGE_ROOT=$(CO60ROOT)
srcdir=../src
bin=../$(Co60_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/RadioActivity/Co60/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Co60_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(Co60_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(Co60_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(Co60_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(Co60_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(Co60_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(Co60_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(Co60_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
Co60_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Co60_use_linkopts=  $(Co60_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= Co60 
all_constituents= $(constituents)
constituentsclean= Co60clean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
Co60prototype_dependencies= $(Co60compile_dependencies)
