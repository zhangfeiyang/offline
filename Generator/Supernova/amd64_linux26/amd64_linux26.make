...
ROOT_linkopts=`root-config --evelibs` -lMathMore 
rootcint="$(ROOT_home)/bin/rootcint"
tag=amd64_linux26
package=Supernova
version=v0
PACKAGE_ROOT=$(SUPERNOVAROOT)
srcdir=../src
bin=../$(Supernova_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/Supernova/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Supernova_linkopts)  $(ROOT_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(ROOT_root)/cmt/requirements 
...
use_stamps=  $(Supernova_stamps)  $(ROOT_stamps) 
use_cflags=  $(Supernova_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(Supernova_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(Supernova_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(Supernova_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(Supernova_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(Supernova_pp_fflags)  $(ROOT_pp_fflags) 
use_libraries= $(ROOT_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
SN_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
SN_use_linkopts=  $(Supernova_linkopts)  $(ROOT_linkopts) 
readSN_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
readSN_use_linkopts=  $(Supernova_linkopts)  $(ROOT_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= SN readSN 
all_constituents= $(constituents)
constituentsclean= readSNclean SNclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
SNprototype_dependencies= $(SNcompile_dependencies)
readSNprototype_dependencies= $(readSNcompile_dependencies)
