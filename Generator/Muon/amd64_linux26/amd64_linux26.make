...
package=Muon
version=v0
PACKAGE_ROOT=$(MUONROOT)
srcdir=../src
bin=../$(Muon_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/Muon/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Muon_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(Muon_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(Muon_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(Muon_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(Muon_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(Muon_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(Muon_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(Muon_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
Muon_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Muon_use_linkopts=  $(Muon_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= Muon 
all_constituents= $(constituents)
constituentsclean= Muonclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
Muonprototype_dependencies= $(Muoncompile_dependencies)
