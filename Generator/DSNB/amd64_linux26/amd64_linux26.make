...
package=DSNB
version=v0
PACKAGE_ROOT=$(DSNBROOT)
srcdir=../src
bin=../$(DSNB_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/DSNB/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(DSNB_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_stamps=  $(DSNB_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(DSNB_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(DSNB_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(DSNB_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(DSNB_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(DSNB_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(DSNB_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(ROOT_libraries)  $(CLHEP_libraries) 
includes= $(ppcmd)"$(srcdir)" $(use_includes)
fincludes= $(includes)
DSNB-NC_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
DSNB-NC_use_linkopts=  $(DSNB_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= DSNB-NC 
all_constituents= $(constituents)
constituentsclean= DSNB-NCclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
DSNB-NCprototype_dependencies= $(DSNB-NCcompile_dependencies)
