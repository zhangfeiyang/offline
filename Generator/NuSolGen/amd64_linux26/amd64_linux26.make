...
NuSolGen_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(NuSolGen_use_linkopts)
NuSolGen_use_linkopts=    $(GenTools_linkopts)  $(RootWriter_linkopts)  $(RandomSvc_linkopts)  $(MCGlobalTimeSvc_linkopts)  $(EvtNavigator_linkopts)  $(GenEventV2_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(Geant4_linkopts)  $(CLHEP_linkopts)  $(HepMC_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
NuSolGen_stamps=${NUSOLGENROOT}/${BINDIR}/NuSolGen.stamp 
NuSolGen_linker_library=NuSolGen
tag=amd64_linux26
package=NuSolGen
version=v0
PACKAGE_ROOT=$(NUSOLGENROOT)
srcdir=../src
bin=../$(NuSolGen_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Generator/NuSolGen/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(NuSolGen_linkopts)  $(GenTools_linkopts)  $(RootWriter_linkopts)  $(RandomSvc_linkopts)  $(MCGlobalTimeSvc_linkopts)  $(EvtNavigator_linkopts)  $(GenEventV2_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(Geant4_linkopts)  $(CLHEP_linkopts)  $(HepMC_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(GenTools_root)/cmt/requirements $(RootWriter_root)/cmt/requirements $(RandomSvc_root)/cmt/requirements $(MCGlobalTimeSvc_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(GenEventV2_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(Geant4_root)/cmt/requirements $(CLHEP_root)/cmt/requirements $(HepMC_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements 
use_includes= $(ppcmd)"$(GenTools_root)/src" $(ppcmd)"$(RootWriter_root)/src" $(ppcmd)"$(RandomSvc_root)/src" $(ppcmd)"$(MCGlobalTimeSvc_root)/src" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(GenEventV2_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/Event" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(Geant4_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Release/J17v1r1/ExternalLibs/Geant4/9.4.p04/include/geant4" $(ppcmd)"$(CLHEP_root)/src" $(ppcmd)"$(HepMC_root)/src" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(NuSolGen_stamps)  $(GenTools_stamps)  $(RootWriter_stamps)  $(RandomSvc_stamps)  $(MCGlobalTimeSvc_stamps)  $(EvtNavigator_stamps)  $(GenEventV2_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(ROOT_stamps)  $(Geant4_stamps)  $(CLHEP_stamps)  $(HepMC_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(NuSolGen_cflags)  $(GenTools_cflags)  $(RootWriter_cflags)  $(RandomSvc_cflags)  $(MCGlobalTimeSvc_cflags)  $(EvtNavigator_cflags)  $(GenEventV2_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(ROOT_cflags)  $(Geant4_cflags)  $(CLHEP_cflags)  $(HepMC_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(NuSolGen_pp_cflags)  $(GenTools_pp_cflags)  $(RootWriter_pp_cflags)  $(RandomSvc_pp_cflags)  $(MCGlobalTimeSvc_pp_cflags)  $(EvtNavigator_pp_cflags)  $(GenEventV2_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(ROOT_pp_cflags)  $(Geant4_pp_cflags)  $(CLHEP_pp_cflags)  $(HepMC_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(NuSolGen_cppflags)  $(GenTools_cppflags)  $(RootWriter_cppflags)  $(RandomSvc_cppflags)  $(MCGlobalTimeSvc_cppflags)  $(EvtNavigator_cppflags)  $(GenEventV2_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(ROOT_cppflags)  $(Geant4_cppflags)  $(CLHEP_cppflags)  $(HepMC_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(NuSolGen_pp_cppflags)  $(GenTools_pp_cppflags)  $(RootWriter_pp_cppflags)  $(RandomSvc_pp_cppflags)  $(MCGlobalTimeSvc_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(GenEventV2_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(ROOT_pp_cppflags)  $(Geant4_pp_cppflags)  $(CLHEP_pp_cppflags)  $(HepMC_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(NuSolGen_fflags)  $(GenTools_fflags)  $(RootWriter_fflags)  $(RandomSvc_fflags)  $(MCGlobalTimeSvc_fflags)  $(EvtNavigator_fflags)  $(GenEventV2_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(ROOT_fflags)  $(Geant4_fflags)  $(CLHEP_fflags)  $(HepMC_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(NuSolGen_pp_fflags)  $(GenTools_pp_fflags)  $(RootWriter_pp_fflags)  $(RandomSvc_pp_fflags)  $(MCGlobalTimeSvc_pp_fflags)  $(EvtNavigator_pp_fflags)  $(GenEventV2_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(ROOT_pp_fflags)  $(Geant4_pp_fflags)  $(CLHEP_pp_fflags)  $(HepMC_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
use_libraries= $(GenTools_libraries)  $(RootWriter_libraries)  $(RandomSvc_libraries)  $(MCGlobalTimeSvc_libraries)  $(EvtNavigator_libraries)  $(GenEventV2_libraries)  $(EDMUtil_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(ROOT_libraries)  $(Geant4_libraries)  $(CLHEP_libraries)  $(HepMC_libraries)  $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries) 
fincludes= $(includes)
NuSolGen_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
NuSolGen_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= NuSolGen NuSolGen_python 
all_constituents= $(constituents)
constituentsclean= NuSolGen_pythonclean NuSolGenclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
NuSolGenprototype_dependencies= $(NuSolGencompile_dependencies)
