...
tags      = $(tag),$(CMTEXTRATAGS),target_Geometry_python

Geometry_tag = $(tag)

#cmt_local_tagfile_Geometry_python = $(Geometry_tag)_Geometry_python.make
...
#cmt_local_tagfile_Geometry_python = $(Geometry_tag).make
cmt_local_tagfile_Geometry_python = $(bin)$(Geometry_tag).make

endif

include $(cmt_local_tagfile_Geometry_python)
#-include $(cmt_local_tagfile_Geometry_python)

ifdef cmt_Geometry_python_has_target_tag

cmt_final_setup_Geometry_python = $(bin)setup_Geometry_python.make
cmt_dependencies_in_Geometry_python = $(bin)dependencies_Geometry_python.in
#cmt_final_setup_Geometry_python = $(bin)Geometry_Geometry_pythonsetup.make
cmt_local_Geometry_python_makefile = $(bin)Geometry_python.make

else

cmt_final_setup_Geometry_python = $(bin)setup.make
cmt_dependencies_in_Geometry_python = $(bin)dependencies.in
#cmt_final_setup_Geometry_python = $(bin)Geometrysetup.make
cmt_local_Geometry_python_makefile = $(bin)Geometry_python.make
...
help ::
	$(echo) 'Geometry_python'

binobj = 
ifdef STRUCTURED_OUTPUT
binobj = Geometry_python/
#Geometry_python::
...
Geometry_python :: Geometry_pythoninstall

install :: Geometry_pythoninstall

Geometry_pythoninstall :: $(install_python_dir)
	@if [ ! "$(installarea)" = "" ] ; then\
...
Geometry_pythonclean :: Geometry_pythonuninstall

uninstall :: Geometry_pythonuninstall

Geometry_pythonuninstall ::
...
ifndef PEDANTIC
.DEFAULT::
	$(echo) "(Geometry_python.make) $@: No rule for such target" >&2
else
.DEFAULT::
	$(error PEDANTIC: $@: No rule for such target)
endif

Geometry_pythonclean ::
