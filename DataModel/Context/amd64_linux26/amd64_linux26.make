...
includes= $(ppcmd)"$(Context_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/Context/Context" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
Context_cintflags=  
Context_dependencies= ContextDict 
Context_linkopts= -lContext 
Context_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(Context_use_linkopts)
Context_use_linkopts=    $(SniperPolicy_linkopts)  $(ROOT_linkopts) 
...
package=Context
version=v0
PACKAGE_ROOT=$(CONTEXTROOT)
srcdir=../src
bin=../$(Context_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/Context/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(Context_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts) 
...
use_stamps=  $(Context_stamps)  $(SniperPolicy_stamps)  $(ROOT_stamps) 
use_cflags=  $(Context_cflags)  $(SniperPolicy_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(Context_pp_cflags)  $(SniperPolicy_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(Context_cppflags)  $(SniperPolicy_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(Context_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(Context_fflags)  $(SniperPolicy_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(Context_pp_fflags)  $(SniperPolicy_pp_fflags)  $(ROOT_pp_fflags) 
use_libraries= $(SniperPolicy_libraries)  $(ROOT_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
ContextDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
Context_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_Context_write_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_Context_write_use_linkopts=  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts) 
test_Context_read_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
test_Context_read_use_linkopts=  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes ContextDict Context test_Context_write test_Context_read 
all_constituents= $(constituents)
constituentsclean= test_Context_readclean test_Context_writeclean Contextclean ContextDictclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
Contextcompile_dependencies= ContextDict
Contextprototype_dependencies= $(Contextcompile_dependencies)
test_Context_writecompile_dependencies= Contextprototype
test_Context_writeprototype_dependencies= $(test_Context_writecompile_dependencies)
test_Context_readcompile_dependencies= Contextprototype
test_Context_readprototype_dependencies= $(test_Context_readcompile_dependencies)
