...
GenEventV2_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(GenEventV2_use_linkopts)
GenEventV2_use_linkopts=    $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(HepMC_linkopts) 
GenEventV2_stamps=${GENEVENTV2ROOT}/${BINDIR}/GenEventV2.stamp 
GenEventV2_linker_library=GenEventV2
tag=amd64_linux26
package=GenEventV2
version=v0
PACKAGE_ROOT=$(GENEVENTV2ROOT)
srcdir=../src
bin=../$(GenEventV2_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/GenEventV2/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(GenEventV2_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(HepMC_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(EDMUtil_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(HepMC_root)/cmt/requirements 
use_includes= $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"$(HepMC_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(GenEventV2_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(ROOT_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(HepMC_stamps) 
use_cflags=  $(GenEventV2_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(ROOT_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(HepMC_cflags) 
use_pp_cflags=  $(GenEventV2_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(ROOT_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(HepMC_pp_cflags) 
use_cppflags=  $(GenEventV2_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(ROOT_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(HepMC_cppflags) 
use_pp_cppflags=  $(GenEventV2_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(ROOT_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(HepMC_pp_cppflags) 
use_fflags=  $(GenEventV2_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(ROOT_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(HepMC_fflags) 
use_pp_fflags=  $(GenEventV2_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(ROOT_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(HepMC_pp_fflags) 
use_libraries= $(EDMUtil_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(ROOT_libraries)  $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(HepMC_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GenEventV2Dict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
GenEventV2_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes GenEventV2Dict GenEventV2 
all_constituents= $(constituents)
constituentsclean= GenEventV2clean GenEventV2Dictclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
GenEventV2compile_dependencies= GenEventV2Dict
GenEventV2prototype_dependencies= $(GenEventV2compile_dependencies)
