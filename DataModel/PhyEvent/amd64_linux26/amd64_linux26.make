...
PhyEvent_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(PhyEvent_use_linkopts)
PhyEvent_use_linkopts=    $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
PhyEvent_stamps=${PHYEVENTROOT}/${BINDIR}/PhyEvent.stamp 
PhyEvent_linker_library=PhyEvent
tag=amd64_linux26
package=PhyEvent
version=v0
PACKAGE_ROOT=$(PHYEVENTROOT)
srcdir=../src
bin=../$(PhyEvent_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/PhyEvent/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(PhyEvent_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(EDMUtil_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements 
...
use_stamps=  $(PhyEvent_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(PhyEvent_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(PhyEvent_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(PhyEvent_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(PhyEvent_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(PhyEvent_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(PhyEvent_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
use_libraries= $(EDMUtil_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries) 
fincludes= $(includes)
PhyEventObj2Doth_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PhyEventDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PhyEventxodsrc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PhyEvent_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= PhyEventObj2Doth install_more_includes PhyEventDict PhyEventxodsrc PhyEvent 
all_constituents= $(constituents)
constituentsclean= PhyEventclean PhyEventxodsrcclean PhyEventDictclean install_more_includesclean PhyEventObj2Dothclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
PhyEventcompile_dependencies= PhyEventObj2Doth PhyEventDict PhyEventxodsrc
PhyEventprototype_dependencies= $(PhyEventcompile_dependencies)
