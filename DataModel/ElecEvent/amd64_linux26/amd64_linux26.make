...
ElecEvent_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(ElecEvent_use_linkopts)
ElecEvent_use_linkopts=    $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(SniperKernel_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
ElecEvent_stamps=${ELECEVENTROOT}/${BINDIR}/ElecEvent.stamp 
ElecEvent_linker_library=ElecEvent
tag=amd64_linux26
package=ElecEvent
version=v0
PACKAGE_ROOT=$(ELECEVENTROOT)
srcdir=../src
bin=../$(ElecEvent_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/ElecEvent/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(ElecEvent_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(SniperKernel_linkopts)  $(Context_linkopts)  $(SniperPolicy_linkopts)  $(ROOT_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(EDMUtil_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(Context_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements 
use_includes= $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(Context_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/Context/Context" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(ElecEvent_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(SniperKernel_stamps)  $(Context_stamps)  $(SniperPolicy_stamps)  $(ROOT_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(ElecEvent_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(SniperKernel_cflags)  $(Context_cflags)  $(SniperPolicy_cflags)  $(ROOT_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(ElecEvent_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(SniperKernel_pp_cflags)  $(Context_pp_cflags)  $(SniperPolicy_pp_cflags)  $(ROOT_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(ElecEvent_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(SniperKernel_cppflags)  $(Context_cppflags)  $(SniperPolicy_cppflags)  $(ROOT_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(ElecEvent_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(Context_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(ROOT_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(ElecEvent_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(SniperKernel_fflags)  $(Context_fflags)  $(SniperPolicy_fflags)  $(ROOT_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(ElecEvent_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(SniperKernel_pp_fflags)  $(Context_pp_fflags)  $(SniperPolicy_pp_fflags)  $(ROOT_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
use_libraries= $(EDMUtil_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(SniperKernel_libraries)  $(Context_libraries)  $(SniperPolicy_libraries)  $(ROOT_libraries)  $(Boost_libraries)  $(Python_libraries) 
fincludes= $(includes)
ElecEventObj2Doth_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
ElecEventDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
ElecEventxodsrc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
ElecEvent_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= ElecEventObj2Doth install_more_includes ElecEventDict ElecEventxodsrc ElecEvent 
all_constituents= $(constituents)
constituentsclean= ElecEventclean ElecEventxodsrcclean ElecEventDictclean install_more_includesclean ElecEventObj2Dothclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
ElecEventcompile_dependencies= ElecEventObj2Doth ElecEventDict ElecEventxodsrc
ElecEventprototype_dependencies= $(ElecEventcompile_dependencies)
