...
EDMUtil_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(EDMUtil_use_linkopts)
EDMUtil_use_linkopts=    $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
EDMUtil_stamps=${EDMUTILROOT}/${BINDIR}/EDMUtil.stamp 
EDMUtil_linker_library=EDMUtil
tag=amd64_linux26
package=EDMUtil
version=v0
PACKAGE_ROOT=$(EDMUTILROOT)
srcdir=../src
bin=../$(EDMUtil_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements 
use_includes= $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(ROOT_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(ROOT_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(ROOT_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(ROOT_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(ROOT_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(ROOT_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(ROOT_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
use_libraries= $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(ROOT_libraries)  $(SniperKernel_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries) 
fincludes= $(includes)
EDMUtilDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
EDMUtil_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= EDMUtilDict EDMUtil install_more_includes 
all_constituents= $(constituents)
constituentsclean= install_more_includesclean EDMUtilclean EDMUtilDictclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
EDMUtilcompile_dependencies= EDMUtilDict EDMUtilDict EDMUtilDict EDMUtilDict
EDMUtilprototype_dependencies= $(EDMUtilcompile_dependencies)
