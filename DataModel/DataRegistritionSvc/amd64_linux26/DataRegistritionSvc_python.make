...
#====================================
#  Document DataRegistritionSvc_python
#
...
tags      = $(tag),$(CMTEXTRATAGS),target_DataRegistritionSvc_python

DataRegistritionSvc_tag = $(tag)

#cmt_local_tagfile_DataRegistritionSvc_python = $(DataRegistritionSvc_tag)_DataRegistritionSvc_python.make
...
#cmt_local_tagfile_DataRegistritionSvc_python = $(DataRegistritionSvc_tag).make
cmt_local_tagfile_DataRegistritionSvc_python = $(bin)$(DataRegistritionSvc_tag).make

endif

include $(cmt_local_tagfile_DataRegistritionSvc_python)
#-include $(cmt_local_tagfile_DataRegistritionSvc_python)

ifdef cmt_DataRegistritionSvc_python_has_target_tag

cmt_final_setup_DataRegistritionSvc_python = $(bin)setup_DataRegistritionSvc_python.make
cmt_dependencies_in_DataRegistritionSvc_python = $(bin)dependencies_DataRegistritionSvc_python.in
#cmt_final_setup_DataRegistritionSvc_python = $(bin)DataRegistritionSvc_DataRegistritionSvc_pythonsetup.make
...
cmt_dependencies_in_DataRegistritionSvc_python = $(bin)dependencies.in
#cmt_final_setup_DataRegistritionSvc_python = $(bin)DataRegistritionSvcsetup.make
cmt_local_DataRegistritionSvc_python_makefile = $(bin)DataRegistritionSvc_python.make
...
help ::
	$(echo) 'DataRegistritionSvc_python'

binobj = 
ifdef STRUCTURED_OUTPUT
binobj = DataRegistritionSvc_python/
#DataRegistritionSvc_python::
...
DataRegistritionSvc_python :: DataRegistritionSvc_pythoninstall

install :: DataRegistritionSvc_pythoninstall

DataRegistritionSvc_pythoninstall :: $(install_python_dir)
	@if [ ! "$(installarea)" = "" ] ; then\
...
DataRegistritionSvc_pythonclean :: DataRegistritionSvc_pythonuninstall

uninstall :: DataRegistritionSvc_pythonuninstall

DataRegistritionSvc_pythonuninstall ::
...
ifndef PEDANTIC
.DEFAULT::
	$(echo) "(DataRegistritionSvc_python.make) $@: No rule for such target" >&2
else
.DEFAULT::
	$(error PEDANTIC: $@: No rule for such target)
endif

DataRegistritionSvc_pythonclean ::
