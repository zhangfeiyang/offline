...
includes= $(ppcmd)"$(EvtNavigator_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
EvtNavigator_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(EvtNavigator_use_linkopts)
EvtNavigator_use_linkopts=    $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
version=v0
PACKAGE_ROOT=$(EVTNAVIGATORROOT)
srcdir=../src
bin=../$(EvtNavigator_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(EvtNavigator_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(ROOT_linkopts)  $(SniperKernel_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts) 
...
use_stamps=  $(EvtNavigator_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(ROOT_stamps)  $(SniperKernel_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps) 
use_cflags=  $(EvtNavigator_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(ROOT_cflags)  $(SniperKernel_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags) 
use_pp_cflags=  $(EvtNavigator_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(ROOT_pp_cflags)  $(SniperKernel_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags) 
use_cppflags=  $(EvtNavigator_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(ROOT_cppflags)  $(SniperKernel_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags) 
use_pp_cppflags=  $(EvtNavigator_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(ROOT_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags) 
use_fflags=  $(EvtNavigator_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(ROOT_fflags)  $(SniperKernel_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags) 
use_pp_fflags=  $(EvtNavigator_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(ROOT_pp_fflags)  $(SniperKernel_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags) 
...
EvtNavigatorDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
EvtNavigator_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes EvtNavigatorDict EvtNavigator 
all_constituents= $(constituents)
constituentsclean= EvtNavigatorclean EvtNavigatorDictclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
EvtNavigatorcompile_dependencies= EvtNavigatorDict
EvtNavigatorprototype_dependencies= $(EvtNavigatorcompile_dependencies)
