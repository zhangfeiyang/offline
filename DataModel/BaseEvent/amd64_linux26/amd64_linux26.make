...
BaseEvent_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(BaseEvent_use_linkopts)
BaseEvent_use_linkopts=    $(ROOT_linkopts) 
BaseEvent_stamps=${BASEEVENTROOT}/${BINDIR}/BaseEvent.stamp 
BaseEvent_linker_library=BaseEvent
tag=amd64_linux26
package=BaseEvent
version=v0
PACKAGE_ROOT=$(BASEEVENTROOT)
srcdir=../src
bin=../$(BaseEvent_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(BaseEvent_linkopts)  $(ROOT_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(XmlObjDesc_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(ROOT_root)/cmt/requirements 
use_includes= $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" 
use_fincludes= $(use_includes)
use_stamps=  $(BaseEvent_stamps)  $(ROOT_stamps) 
use_cflags=  $(BaseEvent_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(BaseEvent_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(BaseEvent_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(BaseEvent_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(BaseEvent_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(BaseEvent_pp_fflags)  $(ROOT_pp_fflags) 
use_libraries= $(XmlObjDesc_libraries)  $(SniperPolicy_libraries)  $(ROOT_libraries) 
fincludes= $(includes)
BaseEventObj2Doth_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
BaseEventDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
BaseEventxodsrc_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
BaseEvent_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= BaseEventObj2Doth install_more_includes BaseEventDict BaseEventxodsrc BaseEvent 
all_constituents= $(constituents)
constituentsclean= BaseEventclean BaseEventxodsrcclean BaseEventDictclean install_more_includesclean BaseEventObj2Dothclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
BaseEventcompile_dependencies= BaseEventObj2Doth BaseEventDict BaseEventxodsrc
BaseEventprototype_dependencies= $(BaseEventcompile_dependencies)
