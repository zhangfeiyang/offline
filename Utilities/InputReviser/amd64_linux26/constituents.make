...
#cmt_local_tagfile = $(InputReviser_tag).make
cmt_local_tagfile = $(bin)$(InputReviser_tag).make
...
cmt_local_tagfile_install_more_includes = $(bin)$(InputReviser_tag)_install_more_includes.make
...
cmt_local_tagfile_install_more_includes = $(bin)$(InputReviser_tag).make
...
InputReviser_extratags = -tag_add=target_InputReviser
...
not_InputRevisercompile_dependencies = { n=0; for p in $?; do m=0; for d in $(InputRevisercompile_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
InputReviserdirs :
	@if test ! -d $(bin)InputReviser; then $(mkdir) -p $(bin)InputReviser; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)InputReviser
else
InputReviserdirs : ;
endif
...
ifndef QUICK
$(cmt_local_InputReviser_makefile) : $(InputRevisercompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building InputReviser.make"; \
	  $(cmtexe) -tag=$(tags) $(InputReviser_extratags) build constituent_config -out=$(cmt_local_InputReviser_makefile) InputReviser
else
$(cmt_local_InputReviser_makefile) : $(InputRevisercompile_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InputReviser) ] || \
	  [ ! -f $(cmt_final_setup_InputReviser) ] || \
	  $(not_InputRevisercompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building InputReviser.make"; \
	  $(cmtexe) -tag=$(tags) $(InputReviser_extratags) build constituent_config -out=$(cmt_local_InputReviser_makefile) InputReviser; \
	  fi
endif
...
$(cmt_local_InputReviser_makefile) : $(InputRevisercompile_dependencies) build_library_links
	$(echo) "(constituents.make) Building InputReviser.make"; \
	  $(cmtexe) -f=$(bin)InputReviser.in -tag=$(tags) $(InputReviser_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_InputReviser_makefile) InputReviser
else
$(cmt_local_InputReviser_makefile) : $(InputRevisercompile_dependencies) $(cmt_build_library_linksstamp) $(bin)InputReviser.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_InputReviser) ] || \
	  [ ! -f $(cmt_final_setup_InputReviser) ] || \
	  $(not_InputRevisercompile_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(InputReviser_extratags) build constituent_makefile -out=$(cmt_local_InputReviser_makefile) InputReviser

InputReviser :: InputRevisercompile InputReviserinstall ;

ifdef cmt_InputReviser_has_prototypes

InputReviserprototype : $(InputReviserprototype_dependencies) $(cmt_local_InputReviser_makefile) dirs InputReviserdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InputReviser_makefile); then \
	  $(MAKE) -f $(cmt_local_InputReviser_makefile) $@; \
	  fi
#	@$(MAKE) -f $(cmt_local_InputReviser_makefile) $@
	$(echo) "(constituents.make) $@ done"

InputRevisercompile : InputReviserprototype

endif

InputRevisercompile : $(InputRevisercompile_dependencies) $(cmt_local_InputReviser_makefile) dirs InputReviserdirs
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InputReviser_makefile); then \
	  $(MAKE) -f $(cmt_local_InputReviser_makefile) $@; \
	  fi
...
InputReviserclean :: $(InputReviserclean_dependencies) ##$(cmt_local_InputReviser_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InputReviser_makefile); then \
	  $(MAKE) -f $(cmt_local_InputReviser_makefile) $@; \
	fi
	$(echo) "(constituents.make) $@ done"
#	@-$(MAKE) -f $(cmt_local_InputReviser_makefile) InputReviserclean

##	  /bin/rm -f $(cmt_local_InputReviser_makefile) $(bin)InputReviser_dependencies.make

install :: InputReviserinstall ;

InputReviserinstall :: InputRevisercompile $(InputReviser_dependencies) $(cmt_local_InputReviser_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_InputReviser_makefile); then \
	  $(MAKE) -f $(cmt_local_InputReviser_makefile) $@; \
	  fi
...
$(foreach d,$(InputReviser_dependencies),$(eval $(d)uninstall_dependencies += InputReviseruninstall))

InputReviseruninstall : $(InputReviseruninstall_dependencies) ##$(cmt_local_InputReviser_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_InputReviser_makefile); then \
	  $(MAKE) -f $(cmt_local_InputReviser_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_InputReviser_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: InputReviseruninstall ;

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ InputReviser"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ InputReviser done"
endif
...
cmt_local_tagfile_make = $(bin)$(InputReviser_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(InputReviser_tag).make
