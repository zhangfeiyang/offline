...
includes= $(ppcmd)"$(SpmtMuonRecTool_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
version=v0
PACKAGE_ROOT=$(SPMTMUONRECTOOLROOT)
srcdir=../src
bin=../$(SpmtMuonRecTool_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Reconstruction/SpmtMuonRecTool/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(SpmtMuonRecTool_linkopts)  $(RecCdMuonAlg_linkopts)  $(RecEvent_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(RootWriter_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(CLHEPDict_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(CLHEP_linkopts)  $(ROOT_linkopts) 
...
use_stamps=  $(SpmtMuonRecTool_stamps)  $(RecCdMuonAlg_stamps)  $(RecEvent_stamps)  $(CalibEvent_stamps)  $(BufferMemMgr_stamps)  $(RootIOSvc_stamps)  $(RootIOUtil_stamps)  $(EvtNavigator_stamps)  $(DataRegistritionSvc_stamps)  $(EDMUtil_stamps)  $(RootWriter_stamps)  $(Geometry_stamps)  $(Identifier_stamps)  $(SniperKernel_stamps)  $(CLHEPDict_stamps)  $(BaseEvent_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(CLHEP_stamps)  $(ROOT_stamps) 
use_cflags=  $(SpmtMuonRecTool_cflags)  $(RecCdMuonAlg_cflags)  $(RecEvent_cflags)  $(CalibEvent_cflags)  $(BufferMemMgr_cflags)  $(RootIOSvc_cflags)  $(RootIOUtil_cflags)  $(EvtNavigator_cflags)  $(DataRegistritionSvc_cflags)  $(EDMUtil_cflags)  $(RootWriter_cflags)  $(Geometry_cflags)  $(Identifier_cflags)  $(SniperKernel_cflags)  $(CLHEPDict_cflags)  $(BaseEvent_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(CLHEP_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(SpmtMuonRecTool_pp_cflags)  $(RecCdMuonAlg_pp_cflags)  $(RecEvent_pp_cflags)  $(CalibEvent_pp_cflags)  $(BufferMemMgr_pp_cflags)  $(RootIOSvc_pp_cflags)  $(RootIOUtil_pp_cflags)  $(EvtNavigator_pp_cflags)  $(DataRegistritionSvc_pp_cflags)  $(EDMUtil_pp_cflags)  $(RootWriter_pp_cflags)  $(Geometry_pp_cflags)  $(Identifier_pp_cflags)  $(SniperKernel_pp_cflags)  $(CLHEPDict_pp_cflags)  $(BaseEvent_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(CLHEP_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(SpmtMuonRecTool_cppflags)  $(RecCdMuonAlg_cppflags)  $(RecEvent_cppflags)  $(CalibEvent_cppflags)  $(BufferMemMgr_cppflags)  $(RootIOSvc_cppflags)  $(RootIOUtil_cppflags)  $(EvtNavigator_cppflags)  $(DataRegistritionSvc_cppflags)  $(EDMUtil_cppflags)  $(RootWriter_cppflags)  $(Geometry_cppflags)  $(Identifier_cppflags)  $(SniperKernel_cppflags)  $(CLHEPDict_cppflags)  $(BaseEvent_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(CLHEP_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(SpmtMuonRecTool_pp_cppflags)  $(RecCdMuonAlg_pp_cppflags)  $(RecEvent_pp_cppflags)  $(CalibEvent_pp_cppflags)  $(BufferMemMgr_pp_cppflags)  $(RootIOSvc_pp_cppflags)  $(RootIOUtil_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(DataRegistritionSvc_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(RootWriter_pp_cppflags)  $(Geometry_pp_cppflags)  $(Identifier_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(CLHEPDict_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(CLHEP_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(SpmtMuonRecTool_fflags)  $(RecCdMuonAlg_fflags)  $(RecEvent_fflags)  $(CalibEvent_fflags)  $(BufferMemMgr_fflags)  $(RootIOSvc_fflags)  $(RootIOUtil_fflags)  $(EvtNavigator_fflags)  $(DataRegistritionSvc_fflags)  $(EDMUtil_fflags)  $(RootWriter_fflags)  $(Geometry_fflags)  $(Identifier_fflags)  $(SniperKernel_fflags)  $(CLHEPDict_fflags)  $(BaseEvent_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(CLHEP_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(SpmtMuonRecTool_pp_fflags)  $(RecCdMuonAlg_pp_fflags)  $(RecEvent_pp_fflags)  $(CalibEvent_pp_fflags)  $(BufferMemMgr_pp_fflags)  $(RootIOSvc_pp_fflags)  $(RootIOUtil_pp_fflags)  $(EvtNavigator_pp_fflags)  $(DataRegistritionSvc_pp_fflags)  $(EDMUtil_pp_fflags)  $(RootWriter_pp_fflags)  $(Geometry_pp_fflags)  $(Identifier_pp_fflags)  $(SniperKernel_pp_fflags)  $(CLHEPDict_pp_fflags)  $(BaseEvent_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(CLHEP_pp_fflags)  $(ROOT_pp_fflags) 
...
SpmtMuonRecTool_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
SpmtMuonRecTool_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes SpmtMuonRecTool SpmtMuonRecTool_python 
all_constituents= $(constituents)
constituentsclean= SpmtMuonRecTool_pythonclean SpmtMuonRecToolclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
SpmtMuonRecToolprototype_dependencies= $(SpmtMuonRecToolcompile_dependencies)
