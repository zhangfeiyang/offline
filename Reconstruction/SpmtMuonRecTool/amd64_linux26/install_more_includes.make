...
#cmt_local_tagfile_install_more_includes = $(SpmtMuonRecTool_tag)_install_more_includes.make
...
#cmt_local_tagfile_install_more_includes = $(SpmtMuonRecTool_tag).make
...
#cmt_final_setup_install_more_includes = $(bin)SpmtMuonRecTool_install_more_includessetup.make
...
#cmt_final_setup_install_more_includes = $(bin)SpmtMuonRecToolsetup.make
cmt_local_install_more_includes_makefile = $(bin)install_more_includes.make
...
$(install_include_dir) ::
	@if test "$(installarea)" = ""; then \
	  ...
	  if test ! "SpmtMuonRecTool" = ""; then \
	    if test -d ../SpmtMuonRecTool; then \
	      echo "Installing files from more ../SpmtMuonRecTool to $(install_include_dir)"; \
	      if test ! -d $(install_include_dir) ; then mkdir -p $(install_include_dir); fi; \
	      if test ! -d $(install_include_dir)/SpmtMuonRecTool; then mkdir -p $(install_include_dir)/SpmtMuonRecTool; fi;\
	        $(install_command) ../SpmtMuonRecTool $(install_include_dir);\
	    else \
	      echo "No more SpmtMuonRecTool include directory"; \
	    fi; \
          fi; \
	fi
...
install_more_includesuninstall ::
	@if test "$(installarea)" = ""; then \
	  ...
	  echo "Uninstalling files from $(install_include_dir)/SpmtMuonRecTool"; \
	  $(uninstall_command) "$(install_include_dir)/SpmtMuonRecTool/*" ; \
	  if test -f $(install_include_dir)/SpmtMuonRecTool.cmtref ; then \
	    echo "Removing $(install_include_dir)/SpmtMuonRecTool.cmtref"; \
	    eval rm -f $(install_include_dir)/SpmtMuonRecTool.cmtref ; \
	  fi; \
	fi
