...
includes= $(ppcmd)"$(RecWpMuonAlg_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
RecWpMuonAlg_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(RecWpMuonAlg_use_linkopts)
RecWpMuonAlg_use_linkopts=    $(RecEvent_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(RootWriter_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(CLHEPDict_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(CLHEP_linkopts)  $(ROOT_linkopts) 
RecWpMuonAlg_stamps=${RECWPMUONALGROOT}/${BINDIR}/RecWpMuonAlg.stamp 
RecWpMuonAlg_linker_library=RecWpMuonAlg
tag=amd64_linux26
package=RecWpMuonAlg
version=v0
PACKAGE_ROOT=$(RECWPMUONALGROOT)
srcdir=../src
bin=../$(RecWpMuonAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Reconstruction/RecWpMuonAlg/amd64_linux26/
project=offline
