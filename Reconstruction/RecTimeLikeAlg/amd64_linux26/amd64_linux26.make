...
RecTimeLikeAlg_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(RecTimeLikeAlg_use_linkopts) -lMinuit2 
RecTimeLikeAlg_linkopts= -lRecTimeLikeAlg 
RecTimeLikeAlg_use_linkopts=    $(RecEvent_linkopts)  $(CLHEPDict_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(Geometry_linkopts)  $(ROOT_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(SniperPolicy_linkopts)  $(CLHEP_linkopts) 
...
version=v0
PACKAGE_ROOT=$(RECTIMELIKEALGROOT)
srcdir=../src
bin=../$(RecTimeLikeAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Reconstruction/RecTimeLikeAlg/amd64_linux26/
project=offline
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(RecEvent_root)/cmt/requirements $(CLHEPDict_root)/cmt/requirements $(CalibEvent_root)/cmt/requirements $(BufferMemMgr_root)/cmt/requirements $(RootIOSvc_root)/cmt/requirements $(RootIOUtil_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(DataRegistritionSvc_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(Geometry_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(Identifier_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(CLHEP_root)/cmt/requirements 
...
use_stamps=  $(RecTimeLikeAlg_stamps)  $(RecEvent_stamps)  $(CLHEPDict_stamps)  $(CalibEvent_stamps)  $(BufferMemMgr_stamps)  $(RootIOSvc_stamps)  $(RootIOUtil_stamps)  $(EvtNavigator_stamps)  $(DataRegistritionSvc_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(Geometry_stamps)  $(ROOT_stamps)  $(Identifier_stamps)  $(SniperKernel_stamps)  $(Boost_stamps)  $(Python_stamps)  $(SniperPolicy_stamps)  $(CLHEP_stamps) 
use_cflags=  $(RecTimeLikeAlg_cflags)  $(RecEvent_cflags)  $(CLHEPDict_cflags)  $(CalibEvent_cflags)  $(BufferMemMgr_cflags)  $(RootIOSvc_cflags)  $(RootIOUtil_cflags)  $(EvtNavigator_cflags)  $(DataRegistritionSvc_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(Geometry_cflags)  $(ROOT_cflags)  $(Identifier_cflags)  $(SniperKernel_cflags)  $(Boost_cflags)  $(Python_cflags)  $(SniperPolicy_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(RecTimeLikeAlg_pp_cflags)  $(RecEvent_pp_cflags)  $(CLHEPDict_pp_cflags)  $(CalibEvent_pp_cflags)  $(BufferMemMgr_pp_cflags)  $(RootIOSvc_pp_cflags)  $(RootIOUtil_pp_cflags)  $(EvtNavigator_pp_cflags)  $(DataRegistritionSvc_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(Geometry_pp_cflags)  $(ROOT_pp_cflags)  $(Identifier_pp_cflags)  $(SniperKernel_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(SniperPolicy_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(RecTimeLikeAlg_cppflags)  $(RecEvent_cppflags)  $(CLHEPDict_cppflags)  $(CalibEvent_cppflags)  $(BufferMemMgr_cppflags)  $(RootIOSvc_cppflags)  $(RootIOUtil_cppflags)  $(EvtNavigator_cppflags)  $(DataRegistritionSvc_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(Geometry_cppflags)  $(ROOT_cppflags)  $(Identifier_cppflags)  $(SniperKernel_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(SniperPolicy_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(RecTimeLikeAlg_pp_cppflags)  $(RecEvent_pp_cppflags)  $(CLHEPDict_pp_cppflags)  $(CalibEvent_pp_cppflags)  $(BufferMemMgr_pp_cppflags)  $(RootIOSvc_pp_cppflags)  $(RootIOUtil_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(DataRegistritionSvc_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(Geometry_pp_cppflags)  $(ROOT_pp_cppflags)  $(Identifier_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(RecTimeLikeAlg_fflags)  $(RecEvent_fflags)  $(CLHEPDict_fflags)  $(CalibEvent_fflags)  $(BufferMemMgr_fflags)  $(RootIOSvc_fflags)  $(RootIOUtil_fflags)  $(EvtNavigator_fflags)  $(DataRegistritionSvc_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(Geometry_fflags)  $(ROOT_fflags)  $(Identifier_fflags)  $(SniperKernel_fflags)  $(Boost_fflags)  $(Python_fflags)  $(SniperPolicy_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(RecTimeLikeAlg_pp_fflags)  $(RecEvent_pp_fflags)  $(CLHEPDict_pp_fflags)  $(CalibEvent_pp_fflags)  $(BufferMemMgr_pp_fflags)  $(RootIOSvc_pp_fflags)  $(RootIOUtil_pp_fflags)  $(EvtNavigator_pp_fflags)  $(DataRegistritionSvc_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(Geometry_pp_fflags)  $(ROOT_pp_fflags)  $(Identifier_pp_fflags)  $(SniperKernel_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(SniperPolicy_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(RecEvent_libraries)  $(CLHEPDict_libraries)  $(CalibEvent_libraries)  $(BufferMemMgr_libraries)  $(RootIOSvc_libraries)  $(RootIOUtil_libraries)  $(EvtNavigator_libraries)  $(DataRegistritionSvc_libraries)  $(EDMUtil_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(Geometry_libraries)  $(ROOT_libraries)  $(Identifier_libraries)  $(SniperKernel_libraries)  $(Boost_libraries)  $(Python_libraries)  $(SniperPolicy_libraries)  $(CLHEP_libraries) 
fincludes= $(includes)
RecTimeLikeAlg_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RecTimeLikeAlg_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= RecTimeLikeAlg RecTimeLikeAlg_python 
all_constituents= $(constituents)
constituentsclean= RecTimeLikeAlg_pythonclean RecTimeLikeAlgclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
RecTimeLikeAlgprototype_dependencies= $(RecTimeLikeAlgcompile_dependencies)
