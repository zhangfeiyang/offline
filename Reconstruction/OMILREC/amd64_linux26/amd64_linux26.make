...
OMILREC_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(OMILREC_use_linkopts) -lMinuit2 
OMILREC_linkopts= -lOMILREC 
OMILREC_use_linkopts=    $(SniperRelease_linkopts)  $(DummyAlg_linkopts)  $(RootWriter_linkopts)  $(RecEvent_linkopts)  $(CLHEPDict_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(Geometry_linkopts)  $(ROOT_linkopts)  $(DataBuffer_linkopts)  $(HelloWorld_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(SniperPolicy_linkopts)  $(CLHEP_linkopts) 
OMILREC_stamps=${OMILRECROOT}/${BINDIR}/OMILREC.stamp 
OMILREC_linker_library=OMILREC
tag=amd64_linux26
package=OMILREC
version=v0
PACKAGE_ROOT=$(OMILRECROOT)
srcdir=../src
bin=../$(OMILREC_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Reconstruction/OMILREC/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(OMILREC_linkopts)  $(SniperRelease_linkopts)  $(DummyAlg_linkopts)  $(RootWriter_linkopts)  $(RecEvent_linkopts)  $(CLHEPDict_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(BaseEvent_linkopts)  $(Geometry_linkopts)  $(ROOT_linkopts)  $(DataBuffer_linkopts)  $(HelloWorld_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(SniperPolicy_linkopts)  $(CLHEP_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(SniperRelease_root)/cmt/requirements $(DummyAlg_root)/cmt/requirements $(RootWriter_root)/cmt/requirements $(RecEvent_root)/cmt/requirements $(CLHEPDict_root)/cmt/requirements $(CalibEvent_root)/cmt/requirements $(BufferMemMgr_root)/cmt/requirements $(RootIOSvc_root)/cmt/requirements $(RootIOUtil_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(DataRegistritionSvc_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(Geometry_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(DataBuffer_root)/cmt/requirements $(HelloWorld_root)/cmt/requirements $(Identifier_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(CLHEP_root)/cmt/requirements 
use_includes= $(ppcmd)"$(SniperRelease_root)/src" $(ppcmd)"$(DummyAlg_root)/src" $(ppcmd)"$(RootWriter_root)/src" $(ppcmd)"$(RecEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/RecEvent/Event" $(ppcmd)"$(CLHEPDict_root)/src" $(ppcmd)"$(CalibEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/CalibEvent/Event" $(ppcmd)"$(BufferMemMgr_root)/src" $(ppcmd)"$(RootIOSvc_root)/src" $(ppcmd)"$(RootIOUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/RootIO/RootIOUtil/RootIOUtil" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(DataRegistritionSvc_root)/src" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(Geometry_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(DataBuffer_root)/src" $(ppcmd)"$(HelloWorld_root)/src" $(ppcmd)"$(Identifier_root)/src" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"$(CLHEP_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(OMILREC_stamps)  $(SniperRelease_stamps)  $(DummyAlg_stamps)  $(RootWriter_stamps)  $(RecEvent_stamps)  $(CLHEPDict_stamps)  $(CalibEvent_stamps)  $(BufferMemMgr_stamps)  $(RootIOSvc_stamps)  $(RootIOUtil_stamps)  $(EvtNavigator_stamps)  $(DataRegistritionSvc_stamps)  $(EDMUtil_stamps)  $(BaseEvent_stamps)  $(Geometry_stamps)  $(ROOT_stamps)  $(DataBuffer_stamps)  $(HelloWorld_stamps)  $(Identifier_stamps)  $(SniperKernel_stamps)  $(Boost_stamps)  $(Python_stamps)  $(SniperPolicy_stamps)  $(CLHEP_stamps) 
use_cflags=  $(OMILREC_cflags)  $(SniperRelease_cflags)  $(DummyAlg_cflags)  $(RootWriter_cflags)  $(RecEvent_cflags)  $(CLHEPDict_cflags)  $(CalibEvent_cflags)  $(BufferMemMgr_cflags)  $(RootIOSvc_cflags)  $(RootIOUtil_cflags)  $(EvtNavigator_cflags)  $(DataRegistritionSvc_cflags)  $(EDMUtil_cflags)  $(BaseEvent_cflags)  $(Geometry_cflags)  $(ROOT_cflags)  $(DataBuffer_cflags)  $(HelloWorld_cflags)  $(Identifier_cflags)  $(SniperKernel_cflags)  $(Boost_cflags)  $(Python_cflags)  $(SniperPolicy_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(OMILREC_pp_cflags)  $(SniperRelease_pp_cflags)  $(DummyAlg_pp_cflags)  $(RootWriter_pp_cflags)  $(RecEvent_pp_cflags)  $(CLHEPDict_pp_cflags)  $(CalibEvent_pp_cflags)  $(BufferMemMgr_pp_cflags)  $(RootIOSvc_pp_cflags)  $(RootIOUtil_pp_cflags)  $(EvtNavigator_pp_cflags)  $(DataRegistritionSvc_pp_cflags)  $(EDMUtil_pp_cflags)  $(BaseEvent_pp_cflags)  $(Geometry_pp_cflags)  $(ROOT_pp_cflags)  $(DataBuffer_pp_cflags)  $(HelloWorld_pp_cflags)  $(Identifier_pp_cflags)  $(SniperKernel_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(SniperPolicy_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(OMILREC_cppflags)  $(SniperRelease_cppflags)  $(DummyAlg_cppflags)  $(RootWriter_cppflags)  $(RecEvent_cppflags)  $(CLHEPDict_cppflags)  $(CalibEvent_cppflags)  $(BufferMemMgr_cppflags)  $(RootIOSvc_cppflags)  $(RootIOUtil_cppflags)  $(EvtNavigator_cppflags)  $(DataRegistritionSvc_cppflags)  $(EDMUtil_cppflags)  $(BaseEvent_cppflags)  $(Geometry_cppflags)  $(ROOT_cppflags)  $(DataBuffer_cppflags)  $(HelloWorld_cppflags)  $(Identifier_cppflags)  $(SniperKernel_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(SniperPolicy_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(OMILREC_pp_cppflags)  $(SniperRelease_pp_cppflags)  $(DummyAlg_pp_cppflags)  $(RootWriter_pp_cppflags)  $(RecEvent_pp_cppflags)  $(CLHEPDict_pp_cppflags)  $(CalibEvent_pp_cppflags)  $(BufferMemMgr_pp_cppflags)  $(RootIOSvc_pp_cppflags)  $(RootIOUtil_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(DataRegistritionSvc_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(Geometry_pp_cppflags)  $(ROOT_pp_cppflags)  $(DataBuffer_pp_cppflags)  $(HelloWorld_pp_cppflags)  $(Identifier_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(OMILREC_fflags)  $(SniperRelease_fflags)  $(DummyAlg_fflags)  $(RootWriter_fflags)  $(RecEvent_fflags)  $(CLHEPDict_fflags)  $(CalibEvent_fflags)  $(BufferMemMgr_fflags)  $(RootIOSvc_fflags)  $(RootIOUtil_fflags)  $(EvtNavigator_fflags)  $(DataRegistritionSvc_fflags)  $(EDMUtil_fflags)  $(BaseEvent_fflags)  $(Geometry_fflags)  $(ROOT_fflags)  $(DataBuffer_fflags)  $(HelloWorld_fflags)  $(Identifier_fflags)  $(SniperKernel_fflags)  $(Boost_fflags)  $(Python_fflags)  $(SniperPolicy_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(OMILREC_pp_fflags)  $(SniperRelease_pp_fflags)  $(DummyAlg_pp_fflags)  $(RootWriter_pp_fflags)  $(RecEvent_pp_fflags)  $(CLHEPDict_pp_fflags)  $(CalibEvent_pp_fflags)  $(BufferMemMgr_pp_fflags)  $(RootIOSvc_pp_fflags)  $(RootIOUtil_pp_fflags)  $(EvtNavigator_pp_fflags)  $(DataRegistritionSvc_pp_fflags)  $(EDMUtil_pp_fflags)  $(BaseEvent_pp_fflags)  $(Geometry_pp_fflags)  $(ROOT_pp_fflags)  $(DataBuffer_pp_fflags)  $(HelloWorld_pp_fflags)  $(Identifier_pp_fflags)  $(SniperKernel_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(SniperPolicy_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(SniperRelease_libraries)  $(DummyAlg_libraries)  $(RootWriter_libraries)  $(RecEvent_libraries)  $(CLHEPDict_libraries)  $(CalibEvent_libraries)  $(BufferMemMgr_libraries)  $(RootIOSvc_libraries)  $(RootIOUtil_libraries)  $(EvtNavigator_libraries)  $(DataRegistritionSvc_libraries)  $(EDMUtil_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(Geometry_libraries)  $(ROOT_libraries)  $(DataBuffer_libraries)  $(HelloWorld_libraries)  $(Identifier_libraries)  $(SniperKernel_libraries)  $(Boost_libraries)  $(Python_libraries)  $(SniperPolicy_libraries)  $(CLHEP_libraries) 
fincludes= $(includes)
OMILREC_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
OMILREC_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= OMILREC OMILREC_python 
all_constituents= $(constituents)
constituentsclean= OMILREC_pythonclean OMILRECclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
OMILRECprototype_dependencies= $(OMILRECcompile_dependencies)
