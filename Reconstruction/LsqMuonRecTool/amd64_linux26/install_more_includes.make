...
#cmt_local_tagfile_install_more_includes = $(LsqMuonRecTool_tag)_install_more_includes.make
...
#cmt_local_tagfile_install_more_includes = $(LsqMuonRecTool_tag).make
...
#cmt_final_setup_install_more_includes = $(bin)LsqMuonRecTool_install_more_includessetup.make
...
#cmt_final_setup_install_more_includes = $(bin)LsqMuonRecToolsetup.make
cmt_local_install_more_includes_makefile = $(bin)install_more_includes.make
...
$(install_include_dir) ::
	@if test "$(installarea)" = ""; then \
	  ...
	  if test ! "LsqMuonRecTool" = ""; then \
	    if test -d ../LsqMuonRecTool; then \
	      echo "Installing files from more ../LsqMuonRecTool to $(install_include_dir)"; \
	      if test ! -d $(install_include_dir) ; then mkdir -p $(install_include_dir); fi; \
	      if test ! -d $(install_include_dir)/LsqMuonRecTool; then mkdir -p $(install_include_dir)/LsqMuonRecTool; fi;\
	        $(install_command) ../LsqMuonRecTool $(install_include_dir);\
	    else \
	      echo "No more LsqMuonRecTool include directory"; \
	    fi; \
          fi; \
	fi
...
install_more_includesuninstall ::
	@if test "$(installarea)" = ""; then \
	  ...
	  echo "Uninstalling files from $(install_include_dir)/LsqMuonRecTool"; \
	  $(uninstall_command) "$(install_include_dir)/LsqMuonRecTool/*" ; \
	  if test -f $(install_include_dir)/LsqMuonRecTool.cmtref ; then \
	    echo "Removing $(install_include_dir)/LsqMuonRecTool.cmtref"; \
	    eval rm -f $(install_include_dir)/LsqMuonRecTool.cmtref ; \
	  fi; \
	fi
