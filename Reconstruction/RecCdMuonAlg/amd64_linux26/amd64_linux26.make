...
includes= $(ppcmd)"$(RecCdMuonAlg_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
version=v0
PACKAGE_ROOT=$(RECCDMUONALGROOT)
srcdir=../src
bin=../$(RecCdMuonAlg_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Reconstruction/RecCdMuonAlg/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(RecCdMuonAlg_linkopts)  $(RecEvent_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(RootWriter_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(CLHEPDict_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(CLHEP_linkopts)  $(ROOT_linkopts) 
...
RecCdMuonAlg_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
RecCdMuonAlg_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes RecCdMuonAlg RecCdMuonAlg_python 
all_constituents= $(constituents)
constituentsclean= RecCdMuonAlg_pythonclean RecCdMuonAlgclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
RecCdMuonAlgprototype_dependencies= $(RecCdMuonAlgcompile_dependencies)
