...
includes= $(ppcmd)"$(PoolMuonRecTool_root)"  $(ppcmd)"$(srcdir)" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/InstallArea/include" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/sniper/InstallArea/include" $(use_includes)
...
PoolMuonRecTool_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(PoolMuonRecTool_use_linkopts) -lSpectrum
PoolMuonRecTool_linkopts= -lPoolMuonRecTool 
PoolMuonRecTool_use_linkopts=    $(RecWpMuonAlg_linkopts)  $(RecEvent_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(RootWriter_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(CLHEPDict_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(CLHEP_linkopts)  $(ROOT_linkopts) 
PoolMuonRecTool_stamps=${POOLMUONRECTOOLROOT}/${BINDIR}/PoolMuonRecTool.stamp 
PoolMuonRecTool_linker_library=PoolMuonRecTool
tag=amd64_linux26
package=PoolMuonRecTool
version=v0
PACKAGE_ROOT=$(POOLMUONRECTOOLROOT)
srcdir=../src
bin=../$(PoolMuonRecTool_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/Reconstruction/PoolMuonRecTool/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(PoolMuonRecTool_linkopts)  $(RecWpMuonAlg_linkopts)  $(RecEvent_linkopts)  $(CalibEvent_linkopts)  $(BufferMemMgr_linkopts)  $(RootIOSvc_linkopts)  $(RootIOUtil_linkopts)  $(EvtNavigator_linkopts)  $(DataRegistritionSvc_linkopts)  $(EDMUtil_linkopts)  $(RootWriter_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(CLHEPDict_linkopts)  $(BaseEvent_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(CLHEP_linkopts)  $(ROOT_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(RecWpMuonAlg_root)/cmt/requirements $(RecEvent_root)/cmt/requirements $(CalibEvent_root)/cmt/requirements $(BufferMemMgr_root)/cmt/requirements $(RootIOSvc_root)/cmt/requirements $(RootIOUtil_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(DataRegistritionSvc_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(RootWriter_root)/cmt/requirements $(Geometry_root)/cmt/requirements $(Identifier_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(CLHEPDict_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(CLHEP_root)/cmt/requirements $(ROOT_root)/cmt/requirements 
use_includes= $(ppcmd)"$(RecWpMuonAlg_root)/src" $(ppcmd)"$(RecEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/RecEvent/Event" $(ppcmd)"$(CalibEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/CalibEvent/Event" $(ppcmd)"$(BufferMemMgr_root)/src" $(ppcmd)"$(RootIOSvc_root)/src" $(ppcmd)"$(RootIOUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/RootIO/RootIOUtil/RootIOUtil" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(DataRegistritionSvc_root)/src" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(RootWriter_root)/src" $(ppcmd)"$(Geometry_root)/src" $(ppcmd)"$(Identifier_root)/src" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(CLHEPDict_root)/src" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"$(CLHEP_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" 
use_fincludes= $(use_includes)
use_stamps=  $(PoolMuonRecTool_stamps)  $(RecWpMuonAlg_stamps)  $(RecEvent_stamps)  $(CalibEvent_stamps)  $(BufferMemMgr_stamps)  $(RootIOSvc_stamps)  $(RootIOUtil_stamps)  $(EvtNavigator_stamps)  $(DataRegistritionSvc_stamps)  $(EDMUtil_stamps)  $(RootWriter_stamps)  $(Geometry_stamps)  $(Identifier_stamps)  $(SniperKernel_stamps)  $(CLHEPDict_stamps)  $(BaseEvent_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(CLHEP_stamps)  $(ROOT_stamps) 
use_cflags=  $(PoolMuonRecTool_cflags)  $(RecWpMuonAlg_cflags)  $(RecEvent_cflags)  $(CalibEvent_cflags)  $(BufferMemMgr_cflags)  $(RootIOSvc_cflags)  $(RootIOUtil_cflags)  $(EvtNavigator_cflags)  $(DataRegistritionSvc_cflags)  $(EDMUtil_cflags)  $(RootWriter_cflags)  $(Geometry_cflags)  $(Identifier_cflags)  $(SniperKernel_cflags)  $(CLHEPDict_cflags)  $(BaseEvent_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(CLHEP_cflags)  $(ROOT_cflags) 
use_pp_cflags=  $(PoolMuonRecTool_pp_cflags)  $(RecWpMuonAlg_pp_cflags)  $(RecEvent_pp_cflags)  $(CalibEvent_pp_cflags)  $(BufferMemMgr_pp_cflags)  $(RootIOSvc_pp_cflags)  $(RootIOUtil_pp_cflags)  $(EvtNavigator_pp_cflags)  $(DataRegistritionSvc_pp_cflags)  $(EDMUtil_pp_cflags)  $(RootWriter_pp_cflags)  $(Geometry_pp_cflags)  $(Identifier_pp_cflags)  $(SniperKernel_pp_cflags)  $(CLHEPDict_pp_cflags)  $(BaseEvent_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(CLHEP_pp_cflags)  $(ROOT_pp_cflags) 
use_cppflags=  $(PoolMuonRecTool_cppflags)  $(RecWpMuonAlg_cppflags)  $(RecEvent_cppflags)  $(CalibEvent_cppflags)  $(BufferMemMgr_cppflags)  $(RootIOSvc_cppflags)  $(RootIOUtil_cppflags)  $(EvtNavigator_cppflags)  $(DataRegistritionSvc_cppflags)  $(EDMUtil_cppflags)  $(RootWriter_cppflags)  $(Geometry_cppflags)  $(Identifier_cppflags)  $(SniperKernel_cppflags)  $(CLHEPDict_cppflags)  $(BaseEvent_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(CLHEP_cppflags)  $(ROOT_cppflags) 
use_pp_cppflags=  $(PoolMuonRecTool_pp_cppflags)  $(RecWpMuonAlg_pp_cppflags)  $(RecEvent_pp_cppflags)  $(CalibEvent_pp_cppflags)  $(BufferMemMgr_pp_cppflags)  $(RootIOSvc_pp_cppflags)  $(RootIOUtil_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(DataRegistritionSvc_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(RootWriter_pp_cppflags)  $(Geometry_pp_cppflags)  $(Identifier_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(CLHEPDict_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(CLHEP_pp_cppflags)  $(ROOT_pp_cppflags) 
use_fflags=  $(PoolMuonRecTool_fflags)  $(RecWpMuonAlg_fflags)  $(RecEvent_fflags)  $(CalibEvent_fflags)  $(BufferMemMgr_fflags)  $(RootIOSvc_fflags)  $(RootIOUtil_fflags)  $(EvtNavigator_fflags)  $(DataRegistritionSvc_fflags)  $(EDMUtil_fflags)  $(RootWriter_fflags)  $(Geometry_fflags)  $(Identifier_fflags)  $(SniperKernel_fflags)  $(CLHEPDict_fflags)  $(BaseEvent_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(CLHEP_fflags)  $(ROOT_fflags) 
use_pp_fflags=  $(PoolMuonRecTool_pp_fflags)  $(RecWpMuonAlg_pp_fflags)  $(RecEvent_pp_fflags)  $(CalibEvent_pp_fflags)  $(BufferMemMgr_pp_fflags)  $(RootIOSvc_pp_fflags)  $(RootIOUtil_pp_fflags)  $(EvtNavigator_pp_fflags)  $(DataRegistritionSvc_pp_fflags)  $(EDMUtil_pp_fflags)  $(RootWriter_pp_fflags)  $(Geometry_pp_fflags)  $(Identifier_pp_fflags)  $(SniperKernel_pp_fflags)  $(CLHEPDict_pp_fflags)  $(BaseEvent_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(CLHEP_pp_fflags)  $(ROOT_pp_fflags) 
use_libraries= $(RecWpMuonAlg_libraries)  $(RecEvent_libraries)  $(CalibEvent_libraries)  $(BufferMemMgr_libraries)  $(RootIOSvc_libraries)  $(RootIOUtil_libraries)  $(EvtNavigator_libraries)  $(DataRegistritionSvc_libraries)  $(EDMUtil_libraries)  $(RootWriter_libraries)  $(Geometry_libraries)  $(Identifier_libraries)  $(SniperKernel_libraries)  $(CLHEPDict_libraries)  $(BaseEvent_libraries)  $(XmlObjDesc_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(CLHEP_libraries)  $(ROOT_libraries) 
fincludes= $(includes)
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PoolMuonRecTool_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
PoolMuonRecTool_python_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= install_more_includes PoolMuonRecTool PoolMuonRecTool_python 
all_constituents= $(constituents)
constituentsclean= PoolMuonRecTool_pythonclean PoolMuonRecToolclean install_more_includesclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
PoolMuonRecToolprototype_dependencies= $(PoolMuonRecToolcompile_dependencies)
