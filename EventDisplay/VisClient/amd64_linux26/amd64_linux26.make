...
VisClient_shlibflags=$(libraryshr_linkopts) $(cmt_installarea_linkopts) $(VisClient_use_linkopts)
VisClient_use_linkopts=    $(JVisLib_linkopts)  $(EvtNavigator_linkopts)  $(SimEventV2_linkopts)  $(CalibEvent_linkopts)  $(RecEvent_linkopts)  $(EDMUtil_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(CLHEPDict_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
package=VisClient
version=v0
PACKAGE_ROOT=$(VISCLIENTROOT)
srcdir=../src
bin=../$(VisClient_tag)/
javabin=../classes/
mgrdir=cmt
BIN=/junofs/production/public/users/zhangfy/offline_bgd/EventDisplay/VisClient/amd64_linux26/
project=offline
...
use_linkopts= $(cmt_installarea_linkopts)   $(VisClient_linkopts)  $(JVisLib_linkopts)  $(EvtNavigator_linkopts)  $(SimEventV2_linkopts)  $(CalibEvent_linkopts)  $(RecEvent_linkopts)  $(EDMUtil_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(CLHEPDict_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
...
use_requirements=requirements $(CMT_root)/mgr/requirements $(JVisLib_root)/cmt/requirements $(EvtNavigator_root)/cmt/requirements $(SimEventV2_root)/cmt/requirements $(CalibEvent_root)/cmt/requirements $(RecEvent_root)/cmt/requirements $(EDMUtil_root)/cmt/requirements $(Geometry_root)/cmt/requirements $(Identifier_root)/cmt/requirements $(SniperKernel_root)/cmt/requirements $(BaseEvent_root)/cmt/requirements $(CLHEPDict_root)/cmt/requirements $(XmlObjDesc_root)/cmt/requirements $(SniperPolicy_root)/cmt/requirements $(Boost_root)/cmt/requirements $(Python_root)/cmt/requirements $(ROOT_root)/cmt/requirements $(CLHEP_root)/cmt/requirements 
use_includes= $(ppcmd)"$(JVisLib_root)/src" $(ppcmd)"$(EvtNavigator_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EvtNavigator/EvtNavigator" $(ppcmd)"$(SimEventV2_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/SimEventV2/" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/SimEventV2/Event" $(ppcmd)"$(CalibEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/CalibEvent/Event" $(ppcmd)"$(RecEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/RecEvent/Event" $(ppcmd)"$(EDMUtil_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/include" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/EDMUtil/EDMUtil" $(ppcmd)"$(Geometry_root)/src" $(ppcmd)"$(Identifier_root)/src" $(ppcmd)"$(SniperKernel_root)/src" $(ppcmd)"$(BaseEvent_root)/src" $(ppcmd)"/junofs/production/public/users/zhangfy/offline_bgd/DataModel/BaseEvent/Event" $(ppcmd)"$(CLHEPDict_root)/src" $(ppcmd)"$(SniperPolicy_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/Boost/1.55.0/include" $(ppcmd)"$(Python_root)/src" $(ppcmd)"/cvmfs/juno.ihep.ac.cn/sl6_amd64_gcc447/Pre-Release/J18v1r1-Pre1/ExternalLibs/ROOT/5.34.11/include" $(ppcmd)"$(CLHEP_root)/src" 
use_fincludes= $(use_includes)
use_stamps=  $(VisClient_stamps)  $(JVisLib_stamps)  $(EvtNavigator_stamps)  $(SimEventV2_stamps)  $(CalibEvent_stamps)  $(RecEvent_stamps)  $(EDMUtil_stamps)  $(Geometry_stamps)  $(Identifier_stamps)  $(SniperKernel_stamps)  $(BaseEvent_stamps)  $(CLHEPDict_stamps)  $(SniperPolicy_stamps)  $(Boost_stamps)  $(Python_stamps)  $(ROOT_stamps)  $(CLHEP_stamps) 
use_cflags=  $(VisClient_cflags)  $(JVisLib_cflags)  $(EvtNavigator_cflags)  $(SimEventV2_cflags)  $(CalibEvent_cflags)  $(RecEvent_cflags)  $(EDMUtil_cflags)  $(Geometry_cflags)  $(Identifier_cflags)  $(SniperKernel_cflags)  $(BaseEvent_cflags)  $(CLHEPDict_cflags)  $(SniperPolicy_cflags)  $(Boost_cflags)  $(Python_cflags)  $(ROOT_cflags)  $(CLHEP_cflags) 
use_pp_cflags=  $(VisClient_pp_cflags)  $(JVisLib_pp_cflags)  $(EvtNavigator_pp_cflags)  $(SimEventV2_pp_cflags)  $(CalibEvent_pp_cflags)  $(RecEvent_pp_cflags)  $(EDMUtil_pp_cflags)  $(Geometry_pp_cflags)  $(Identifier_pp_cflags)  $(SniperKernel_pp_cflags)  $(BaseEvent_pp_cflags)  $(CLHEPDict_pp_cflags)  $(SniperPolicy_pp_cflags)  $(Boost_pp_cflags)  $(Python_pp_cflags)  $(ROOT_pp_cflags)  $(CLHEP_pp_cflags) 
use_cppflags=  $(VisClient_cppflags)  $(JVisLib_cppflags)  $(EvtNavigator_cppflags)  $(SimEventV2_cppflags)  $(CalibEvent_cppflags)  $(RecEvent_cppflags)  $(EDMUtil_cppflags)  $(Geometry_cppflags)  $(Identifier_cppflags)  $(SniperKernel_cppflags)  $(BaseEvent_cppflags)  $(CLHEPDict_cppflags)  $(SniperPolicy_cppflags)  $(Boost_cppflags)  $(Python_cppflags)  $(ROOT_cppflags)  $(CLHEP_cppflags) 
use_pp_cppflags=  $(VisClient_pp_cppflags)  $(JVisLib_pp_cppflags)  $(EvtNavigator_pp_cppflags)  $(SimEventV2_pp_cppflags)  $(CalibEvent_pp_cppflags)  $(RecEvent_pp_cppflags)  $(EDMUtil_pp_cppflags)  $(Geometry_pp_cppflags)  $(Identifier_pp_cppflags)  $(SniperKernel_pp_cppflags)  $(BaseEvent_pp_cppflags)  $(CLHEPDict_pp_cppflags)  $(SniperPolicy_pp_cppflags)  $(Boost_pp_cppflags)  $(Python_pp_cppflags)  $(ROOT_pp_cppflags)  $(CLHEP_pp_cppflags) 
use_fflags=  $(VisClient_fflags)  $(JVisLib_fflags)  $(EvtNavigator_fflags)  $(SimEventV2_fflags)  $(CalibEvent_fflags)  $(RecEvent_fflags)  $(EDMUtil_fflags)  $(Geometry_fflags)  $(Identifier_fflags)  $(SniperKernel_fflags)  $(BaseEvent_fflags)  $(CLHEPDict_fflags)  $(SniperPolicy_fflags)  $(Boost_fflags)  $(Python_fflags)  $(ROOT_fflags)  $(CLHEP_fflags) 
use_pp_fflags=  $(VisClient_pp_fflags)  $(JVisLib_pp_fflags)  $(EvtNavigator_pp_fflags)  $(SimEventV2_pp_fflags)  $(CalibEvent_pp_fflags)  $(RecEvent_pp_fflags)  $(EDMUtil_pp_fflags)  $(Geometry_pp_fflags)  $(Identifier_pp_fflags)  $(SniperKernel_pp_fflags)  $(BaseEvent_pp_fflags)  $(CLHEPDict_pp_fflags)  $(SniperPolicy_pp_fflags)  $(Boost_pp_fflags)  $(Python_pp_fflags)  $(ROOT_pp_fflags)  $(CLHEP_pp_fflags) 
use_libraries= $(JVisLib_libraries)  $(EvtNavigator_libraries)  $(SimEventV2_libraries)  $(CalibEvent_libraries)  $(RecEvent_libraries)  $(EDMUtil_libraries)  $(Geometry_libraries)  $(Identifier_libraries)  $(SniperKernel_libraries)  $(BaseEvent_libraries)  $(CLHEPDict_libraries)  $(XmlObjDesc_libraries)  $(SniperPolicy_libraries)  $(Boost_libraries)  $(Python_libraries)  $(ROOT_libraries)  $(CLHEP_libraries) 
fincludes= $(includes)
VisClientDict_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
install_more_includes_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
VisClient_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
serena_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
serena_use_linkopts=  $(VisClient_linkopts)  $(JVisLib_linkopts)  $(EvtNavigator_linkopts)  $(SimEventV2_linkopts)  $(CalibEvent_linkopts)  $(RecEvent_linkopts)  $(EDMUtil_linkopts)  $(Geometry_linkopts)  $(Identifier_linkopts)  $(SniperKernel_linkopts)  $(BaseEvent_linkopts)  $(CLHEPDict_linkopts)  $(SniperPolicy_linkopts)  $(Boost_linkopts)  $(Python_linkopts)  $(ROOT_linkopts)  $(CLHEP_linkopts) 
make_GUID={88BF15AB-5A2D-4bea-B64F-02752C2A1F4F}
constituents= VisClientDict install_more_includes VisClient serena 
all_constituents= $(constituents)
constituentsclean= serenaclean VisClientclean install_more_includesclean VisClientDictclean 
all_constituentsclean= $(constituentsclean)
cmt_actions_constituents= make 
cmt_actions_constituentsclean= makeclean 
VisClientcompile_dependencies= VisClientDict
VisClientprototype_dependencies= $(VisClientcompile_dependencies)
serenacompile_dependencies= VisClientprototype
serenaprototype_dependencies= $(serenacompile_dependencies)
